...
| Retrieval | RAG2 | later | M | RAG1, F4, LL4, SEC1 | Provenance-bearing Knowledge Objects and an incremental SQLite/FTS5 index over active-project code and Markdown. Stratified stable-hash sampling is closed after 6/8 development and 4/8 holdout coverage. Complete caller-declared source roots pass 11/11 development scope decisions over 451 sources and an independently frozen 11/11 promotion holdout over 15 sources. Source scope is promotion Go; storage and production remain No-Go. |
...
complete source roots are promotion scope Go. Storage, retrieval, settings, and
