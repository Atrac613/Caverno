...
| Retrieval | RAG2 | later | M | RAG1, F4, LL4, SEC1 | Provenance-bearing Knowledge Objects and an incremental SQLite/FTS5 index over active-project code and Markdown. Stratified stable-hash sampling is closed after 6/8 development and 4/8 holdout coverage. The complete caller-declared source-roots synthetic contract is Go under unchanged limits; active-project evaluation, source selection, and storage remain No-Go. |
...
No active-project fixture or live Caverno declaration was used. Next freeze one
realistic declaration from task context before creating a new
in-scope/out-of-scope development set. Storage, retrieval, settings, and
application wiring remain out of scope. Evidence:
