...
| Retrieval | RAG2 | later | M | RAG1, F4, LL4, SEC1 | Provenance-bearing Knowledge Objects and an incremental SQLite/FTS5 index over active-project code and Markdown. Stratified stable-hash sampling is closed after 6/8 development and 4/8 holdout coverage. The complete caller-declared source-roots development contract passes 11/11 scope decisions over 451 admitted sources. An untouched holdout, production source selection, and storage remain No-Go. |
...
`not_available` controls. Next freeze a separate declaration before creating
an untouched promotion holdout. Storage, retrieval, settings, and application
wiring remain out of scope. Evidence:
`docs/rag2_explicit_source_roots_hypothesis_2026-08-26.md` and
`docs/rag2_explicit_source_roots_development_eval_2026-08-26.md`.
