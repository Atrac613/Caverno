...
5. Coding goal edit-and-test check:
...
6. Coding diagnostic feedback release gate:
...
6. Coding verification feedback release gate:
...
8. Chat tool-result budget check:
...
9. Routine branch checks, when routines are in scope:
