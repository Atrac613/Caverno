...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.6a makes default file and QR settings exports secret-free, SEC4.6b moves persisted credentials to platform secure storage, and SEC4.6c1 defines the authenticated-encryption envelope. Continue SA-11 with explicit include-secrets file UI/import on an isolate-safe KDF boundary. |
