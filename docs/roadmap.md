...
| Retrieval | RAG1 | current | Establish a versioned retrieval, answer-grounding, latency, resource, and token evaluation contract before production RAG work. | The schema-v1 evaluator, content-hashed mini repository, deterministic 20-case seed, offline metrics/reporting, unavailable-arm semantics, and empty-ranking negative control are implemented. Next, capture real lexical and control-arm rankings without changing production retrieval. |
...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 audit and 2026-08-24 follow-up. | Continue SEC4.5g/RC1 remote interaction ownership. SEC4.6k completed sensitive diagnostic storage and new-install privacy defaults on 2026-08-24. |
...
| 5 | SEC4.5g / RC1 | next | SA-23 | Recheck pending-interaction origin and document or enforce device ownership at resolution. | Desktop-origin, stale, revoked-device, and cross-device authorization cases follow the declared policy. |
