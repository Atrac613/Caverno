...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 audit and 2026-08-24 follow-up. | Continue SEC4.6k-C by defaulting session logging off only for new installations. SEC4.6k-A/B completed owner-only storage and structured MCP diagnostic redaction on 2026-08-24. |
...
| 4 | SEC4.6k | current | SA-22 | Enforce owner-only sensitive log storage and structured diagnostic redaction. | SEC4.6k-A/B completed 2026-08-24: sensitive logs use owner-only modes; HTTP/stdio MCP diagnostics redact structured secrets and omit response/stderr bodies. Next: SEC4.6k-C new-install default off with existing-choice preservation. |
