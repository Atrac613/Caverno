...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.6a makes default file and QR settings exports secret-free, and SEC4.6b moves persisted settings credentials to platform secure storage with legacy migration. Continue SA-11 with an explicit encrypted include-secrets export flow. |
