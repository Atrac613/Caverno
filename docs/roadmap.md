...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.4b mutation fencing is complete after SEC4.5b. Next remaining P1 slices are SA-09 routine MCP deny-by-default, then SEC4.5c before enabling Remote Coding. |
