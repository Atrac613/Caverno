...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 audit and 2026-08-24 follow-up. | Continue SEC4.6k-B structured MCP diagnostic redaction. SEC4.6k-A completed owner-only app and session log storage on 2026-08-24. |
...
| 4 | SEC4.6k | current | SA-22 | Enforce owner-only sensitive log storage and structured diagnostic redaction. | SEC4.6k-A completed 2026-08-24: new, existing, and rotated app/session logs use owner-only modes. Next: SEC4.6k-B structured MCP diagnostics, identifiers, and response-body minimization. |
