...
| Foundation | F5 | current | Stabilize package boundaries while continuing behavior-preserving large-file decomposition. | Land the completed Computer Use audio card, then characterize the display screenshot card on a fresh branch outside active chat worktrees. |
