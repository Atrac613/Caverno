...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.7a now fails Android release builds closed when release signing is absent. Continue SA-16 with immutable GitHub Action pins as the next bounded supply-chain slice. |
