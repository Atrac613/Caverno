...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.5e Remote Coding resource containment is complete. The next remaining authenticated-transport slice is SEC4.5f credential-bearing non-loopback LLM HTTPS enforcement. |
