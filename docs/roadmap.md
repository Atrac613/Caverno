...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.4c routine MCP deny-by-default is complete. Next remaining P1 slices are git/shell mutation fencing (SA-08 remainder), then SEC4.5c before enabling Remote Coding. |
