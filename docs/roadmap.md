...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 audit and 2026-08-24 follow-up. | Start SEC4.6k owner-only sensitive log storage and structured diagnostic redaction. SEC4.3f completed all MCP and settings QR deserialization limits on 2026-08-24. |
...
| 4 | SEC4.6k | next | SA-22 | Enforce owner-only sensitive log storage and structured diagnostic redaction. | New, existing, and rotated logs use owner-only modes; nested and serialized credentials are redacted. |
