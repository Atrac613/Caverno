...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.1 and SEC4.2 are complete. Start SEC4.3a network classification next; treat every remaining P0 slice as a release blocker. |
