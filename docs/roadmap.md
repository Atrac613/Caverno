...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 audit and 2026-08-24 follow-up. | Continue SEC4.3f with stdio line, diagnostic, JSON-document, and aggregate content limits. SEC4.3f-A bounded MCP HTTP ingress on 2026-08-24. |
...
| 3 | SEC4.3f | current | SA-21 | Apply bounded streaming and decompression limits to application-owned MCP and QR inputs. | SEC4.3f-A completed 2026-08-24 with a 1 MiB HTTP wire ceiling and total/idle deadlines. Next: SEC4.3f-B stdio line, diagnostic, JSON-document, and aggregate content limits; QR expansion remains SEC4.3f-C. |
