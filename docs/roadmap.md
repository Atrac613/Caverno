...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SA-11 through SA-15, SA-17, and SA-18 debug-log redaction plus conversation-owned attachment deletion are complete. Finish SA-18 by reconciling platform privacy declarations with the implemented data flows. |
