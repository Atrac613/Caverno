...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.3d HTTP resource containment is complete. The next remaining audit slice is SEC4.6 data protection and lifecycle, starting with cleartext settings credentials and exports. |
