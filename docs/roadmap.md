...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.1, SEC4.2, SEC4.3a-SEC4.3c, SEC4.4a, SEC4.5a, and SEC4.5b are complete. Remaining SEC4 work is P1; start with SEC4.4b mutation/routine containment or SEC4.5c before enabling Remote Coding. |
