...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SA-11 through SA-15 and SA-17 are complete: local secrets and migrations are protected, and Android cloud/device transfer excludes all app-private data. Continue SEC4.6 with SA-18 privacy, debug-log, and attachment lifecycle review. |
