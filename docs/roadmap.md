...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SA-11, SA-13, and SA-14 are complete: settings secrets are protected, approval-audit data is recursively redacted with owner-only modes, and explicit session-log opt-outs survive migration. Continue SEC4.6 with SA-15 stale Hive resurrection prevention. |
