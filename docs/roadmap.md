...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SA-11 through SA-15, SA-17, and SA-18 debug-log redaction are complete. Continue SEC4.6 with conversation-owned attachment deletion, then reconcile platform privacy declarations. |
