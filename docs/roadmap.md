...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.6 is complete: SA-11 through SA-15, SA-17, and SA-18 data protection, backup, logging, deletion, and privacy declarations are reconciled. Continue with the first bounded SEC4.7/SA-16 release supply-chain hardening slice. |
