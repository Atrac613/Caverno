...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.1, SEC4.2, and SEC4.3a are complete. Start SEC4.3b central network-mutation approval next; treat every remaining P0 slice as a release blocker. |
