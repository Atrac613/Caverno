...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.5f credential-bearing non-loopback LLM HTTPS enforcement is complete. The next remaining resource-boundary slice is SEC4.3d streamed HTTP byte and time ceilings. |
