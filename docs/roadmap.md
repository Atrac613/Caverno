...
| Foundation | F5 | current | Stabilize package boundaries while continuing behavior-preserving large-file decomposition. | Land the completed Computer Use window-targeting card, then characterize the permission checklist on a fresh branch outside active chat worktrees. |
