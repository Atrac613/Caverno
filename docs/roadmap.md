...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SA-11 and SA-13 are complete: settings secrets are protected, approval arguments are recursively redacted, and approval-audit paths migrate to owner-only POSIX modes. Continue SEC4.6 with SA-14 session-log opt-out migration. |
