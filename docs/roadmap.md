...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.7b pins pull-request CI actions to reviewed commits. Continue SA-16 by pinning the SDK-update and manual-smoke workflows before enabling dependency monitoring. |
