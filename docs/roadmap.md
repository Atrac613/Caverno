...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SA-11 through SA-15 data-protection slices are complete: secrets and audit data are protected, opt-outs survive migration, and authoritative drift failures cannot fall back to stale Hive. Continue SEC4.6 with SA-17 Android backup exclusions. |
