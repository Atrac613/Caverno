...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.1, SEC4.2, SEC4.3a-SEC4.3c, and SEC4.4a are complete. Start SEC4.5a-SEC4.5b authenticated transport containment next; treat every remaining P0 slice as a release blocker. |
