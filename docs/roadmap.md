...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.6a now makes default file and QR settings exports secret-free. Continue SA-11 by moving settings credentials to platform secure storage, then add an explicit encrypted include-secrets export flow. |
