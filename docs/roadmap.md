...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 audit and 2026-08-24 follow-up. | Start SEC4.3f application-owned deserialization limits. The SA-19 and SA-20 High severity release blockers completed on 2026-08-24. |
...
| 3 | SEC4.3f | next | SA-21 | Apply bounded streaming and decompression limits to application-owned MCP and QR inputs. | Oversized HTTP, stdio, JSON-document, and gzip-expansion fixtures fail before unbounded buffering or decoding. |
