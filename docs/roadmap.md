...
| Foundation | F5 | current | Stabilize package boundaries while continuing behavior-preserving large-file decomposition. | Land the completed Computer Use display screenshot card, then characterize the input card on a fresh branch outside active chat worktrees. |
