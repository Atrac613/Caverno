...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 audit and 2026-08-24 follow-up. | Complete SEC4.3f with compressed-input and decompressed-output limits for settings QR import. SEC4.3f-A/B bounded MCP HTTP, stdio, JSON documents, and tool text on 2026-08-24. |
...
| 3 | SEC4.3f | current | SA-21 | Apply bounded streaming and decompression limits to application-owned MCP and QR inputs. | SEC4.3f-A/B completed 2026-08-24: MCP HTTP and stdio are bounded before parsing, JSON documents are capped, and aggregate tool text is limited. Next: SEC4.3f-C settings QR compressed-input and decompressed-output bounds. |
