...
| Security | SEC4 | current | Close the runtime trust, egress, transport, and local-data findings recorded in the 2026-08-14 security audit. | SEC4.1, SEC4.2, SEC4.3a, and SEC4.3b are complete. Start SEC4.3c destination/DNS/peer/redirect enforcement next; treat every remaining P0 slice as a release blocker. |
