...
class _MockBoxChatNotifierTurnOwnerSnapshotAdoption extends Mock
    implements Box<String> {}

class _MockAppLifecycleServiceChatNotifierTurnOwnerSnapshotAdoption extends Mock
  ...
  _NoopSessionMemoryService()
    : super(
        ChatMemoryRepository.fromBox(
          _MockBoxChatNotifierTurnOwnerSnapshotAdoption(),
        ),
      );
...
void _runChatNotifierTurnOwnerSnapshotAdoption() {
...
Future<_Fixture> _buildFixture(
  ...
  final conversationBox = _MockBoxChatNotifierTurnOwnerSnapshotAdoption();
  ...
  final lifecycle =
      _MockAppLifecycleServiceChatNotifierTurnOwnerSnapshotAdoption();
