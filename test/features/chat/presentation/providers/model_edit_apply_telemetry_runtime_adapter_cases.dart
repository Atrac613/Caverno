...
void _runModelEditApplyTelemetryRuntimeAdapter() {
  test('builds the fallback baseline and persists a successful edit', () async {
    ...
    final owner = _ownerModelEditApplyTelemetryRuntimeAdapter(1);
  ...
  test('persists edit failure before owner-aware sampler feedback', () async {
    ...
    final owner = _ownerModelEditApplyTelemetryRuntimeAdapter(2);
    runtime.activateOwner(owner);
  ...
  test('rejects delayed feedback after the owner is replaced', () async {
    ...
    final retiredOwner = _ownerModelEditApplyTelemetryRuntimeAdapter(3);
    final currentOwner = _ownerModelEditApplyTelemetryRuntimeAdapter(4);
...
ChatTurnOwner _ownerModelEditApplyTelemetryRuntimeAdapter(int generation) =>
    ChatTurnOwner(
