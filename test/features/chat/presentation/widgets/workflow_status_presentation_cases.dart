...
class _TestTranslationLoaderWorkflowStatusPresentation extends AssetLoader {
  const _TestTranslationLoaderWorkflowStatusPresentation();
...
void _runWorkflowStatusPresentation() {
...
Future<void> _pumpLocalization(WidgetTester tester) async {
  await tester.pumpWidget(
    EasyLocalization(
      ...
      saveLocale: false,
      assetLoader: const _TestTranslationLoaderWorkflowStatusPresentation(),
      child: Builder(
        builder: (context) {
          return MaterialApp(
