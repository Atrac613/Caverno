...
class _TestTranslationLoaderLocalLlmHealthSection extends AssetLoader {
  const _TestTranslationLoaderLocalLlmHealthSection();
...
void _runLocalLlmHealthSection() {
    ...
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: EasyLocalization(
          ...
          saveLocale: false,
          assetLoader: const _TestTranslationLoaderLocalLlmHealthSection(),
          child: Builder(
            builder: (context) {
              return MaterialApp(
