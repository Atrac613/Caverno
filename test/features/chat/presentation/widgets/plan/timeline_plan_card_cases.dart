...
class _TestTranslationLoaderTimelinePlanCard extends AssetLoader {
  const _TestTranslationLoaderTimelinePlanCard();
...
Future<void> _pumpTimelinePlanCard(
  ...
  await tester.pumpWidget(
    EasyLocalization(
      ...
      saveLocale: false,
      assetLoader: const _TestTranslationLoaderTimelinePlanCard(),
      child: Builder(
        builder: (context) {
          return MaterialApp(
