...
class _TestTranslationLoaderPlanReviewSheet extends AssetLoader {
  const _TestTranslationLoaderPlanReviewSheet();
...
Future<void> _pumpPlanReviewSheet(
  ...
  await tester.pumpWidget(
    EasyLocalization(
      ...
      saveLocale: false,
      assetLoader: const _TestTranslationLoaderPlanReviewSheet(),
      child: Builder(
        builder: (context) {
          return MaterialApp(
