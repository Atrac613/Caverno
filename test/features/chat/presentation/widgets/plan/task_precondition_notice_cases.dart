...
class _TestTranslationLoaderTaskPreconditionNotice extends AssetLoader {
  const _TestTranslationLoaderTaskPreconditionNotice();
...
Future<void> _pump(
  ...
  await tester.pumpWidget(
    EasyLocalization(
      ...
      saveLocale: false,
      assetLoader: const _TestTranslationLoaderTaskPreconditionNotice(),
      child: Builder(
...
void _runTaskPreconditionNotice() {
