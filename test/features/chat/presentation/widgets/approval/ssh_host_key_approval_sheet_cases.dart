...
class _TestTranslationLoaderSshHostKeyApprovalSheet extends AssetLoader {
  const _TestTranslationLoaderSshHostKeyApprovalSheet();
...
Future<void> _pumpSheet(
  ...
  await tester.pumpWidget(
    EasyLocalization(
      ...
      saveLocale: false,
      assetLoader: const _TestTranslationLoaderSshHostKeyApprovalSheet(),
      child: Builder(
        builder: (context) {
          return MaterialApp(
...
void _runSshHostKeyApprovalSheet() {
