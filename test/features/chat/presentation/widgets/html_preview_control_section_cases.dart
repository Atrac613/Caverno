...
class _TestTranslationLoaderHtmlPreviewControlSection extends AssetLoader {
  const _TestTranslationLoaderHtmlPreviewControlSection();
...
void _runHtmlPreviewControlSection() {
    ...
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: EasyLocalization(
          ...
          saveLocale: false,
          assetLoader: const _TestTranslationLoaderHtmlPreviewControlSection(),
          child: Builder(
