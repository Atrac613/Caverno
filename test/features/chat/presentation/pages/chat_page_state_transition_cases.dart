...
class _TestTranslationLoaderChatPageStateTransition extends AssetLoader {
  const _TestTranslationLoaderChatPageStateTransition();
...
class _TestSettingsNotifierChatPageStateTransition extends SettingsNotifier {
  @override
  AppSettings build() {
...
class _TestChatNotifierChatPageStateTransition extends ChatNotifier {
  @override
  ChatState build() => ChatState.initial();
}

void _runChatPageStateTransition() {
...
Future<_StateTransitionHarness> _pumpStateTransitionPage(
  ...
  final container = ProviderContainer(
    overrides: [
      ...
      settingsNotifierProvider.overrideWith(
        _TestSettingsNotifierChatPageStateTransition.new,
      ),
      ...
      chatNotifierProvider.overrideWith(
        _TestChatNotifierChatPageStateTransition.new,
      ),
  ...
  await tester.pumpWidget(
    EasyLocalization(
      ...
      saveLocale: false,
      assetLoader: const _TestTranslationLoaderChatPageStateTransition(),
      child: Builder(
        builder: (context) {
