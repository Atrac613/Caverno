...
class _TestTranslationLoaderChatPagePlanReviewActions extends AssetLoader {
  const _TestTranslationLoaderChatPagePlanReviewActions();
...
Future<_PlanReviewHarness> _pumpPlanReviewPage(
  ...
  await tester.pumpWidget(
    EasyLocalization(
      ...
      saveLocale: false,
      assetLoader: const _TestTranslationLoaderChatPagePlanReviewActions(),
      child: Builder(
...
void _runChatPagePlanReviewActions() {
