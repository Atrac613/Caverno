  ...
  group('ChatNotifier collaborator boundary', () {
    test('the checked-in tree satisfies the manifest contract', () {
      ...
      expect(report.markerIds, {
        ...
        'content-tool-failure-result-formatter',
        ...
        'git-working-tree-change-evidence',
        'git-tool-handler',
        ...
        'turn-runtime-goal-continuation-ports-factory',
