...
void _runRag2TypedFactOracleEval() {
  ...
  test('evaluates the frozen oracle facts deterministically', () async {
    ...
    final report = await runRag2TypedFactOracleEval(
      _optionsRag2TypedFactOracleEval(directory.path),
    );
  ...
  test('rejects an oracle fact outside its source span', () async {
    ...
    final options = _optionsRag2TypedFactOracleEval(directory.path);
    await expectLater(
...
Rag2TypedFactOracleOptions _optionsRag2TypedFactOracleEval(String outDir) =>
    Rag2TypedFactOracleOptions(
