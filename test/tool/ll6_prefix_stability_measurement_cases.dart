...
void _runLl6PrefixStabilityMeasurement() {
  ...
  test(
    ...
    () async {
      ...
      final responses = [
        _timingResponseLl6PrefixStabilityMeasurement(cacheN: 5, promptN: 100),
        _timingResponseLl6PrefixStabilityMeasurement(cacheN: 20, promptN: 100),
        _timingResponseLl6PrefixStabilityMeasurement(cacheN: 5, promptN: 100),
        _timingResponseLl6PrefixStabilityMeasurement(cacheN: 80, promptN: 100),
      ];
...
Map<String, dynamic> _timingResponseLl6PrefixStabilityMeasurement({
  required int cacheN,
