...
final class _ScriptFixtureRunChatSearchGroundingEval {
  _ScriptFixtureRunChatSearchGroundingEval._(
    this.root,
    this.bin,
    this.reportRoot,
  );
  ...
  static _ScriptFixtureRunChatSearchGroundingEval create() {
    ...
    return _ScriptFixtureRunChatSearchGroundingEval._(root, bin, reportRoot);
  }
