...
void _runRunPersonalEvalSuitePipeline() {
  group('personal eval suite pipeline runner', () {
    test('adds default output directory and label', () async {
      final fixture = _ScriptFixtureRunPersonalEvalSuitePipeline.create();
...
final class _ScriptFixtureRunPersonalEvalSuitePipeline {
  _ScriptFixtureRunPersonalEvalSuitePipeline._({
    required this.root,
  ...
  static _ScriptFixtureRunPersonalEvalSuitePipeline create() {
    final root = Directory.systemTemp.createTempSync(
      'personal-eval-suite-runner-test-',
    );
    final fixture = _ScriptFixtureRunPersonalEvalSuitePipeline._(
      root: root,
      runnerScript: File(
    ...
    fixture._writeExecutableRunPersonalEvalSuitePipeline(fixture.fakeDart, '''
#!/usr/bin/env bash
{
  for arg in "\$@"; do
    printf 'ARG:%s\\n' "\${arg}"
...
''');
  ...
  void _writeExecutableRunPersonalEvalSuitePipeline(
    File file,
    String contents,
  ) {
