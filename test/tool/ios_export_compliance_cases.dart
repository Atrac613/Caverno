...
void _runIosExportCompliance() {
  ...
  test(
    'iOS Info.plist declares the export compliance encryption exemption',
    () {
      ...
      expect(
        ...
        reason:
            'Missing the export compliance key; uploads will report '
            '"Missing Compliance" and need a manual answer per build.',
      );
      expect(
        infoPlist,
        matches(
          RegExp(r'<key>ITSAppUsesNonExemptEncryption</key>\s*<false\s*/>'),
        ),
