...
void _runRag2SourceScopeMeasurement() {
  test('measures top-level scopes and source roles without Git', () async {
    ...
    final report = await runRag2SourceScopeMeasurement(
      _optionsRag2SourceScopeMeasurement(root),
    );
...
Rag2SourceScopeMeasurementOptions _optionsRag2SourceScopeMeasurement(
  Directory root,
