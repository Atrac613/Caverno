...
void _runRag2TypedFactExtractionEval() {
  ...
  test('measures extraction separately from the frozen matcher', () async {
    ...
    final report = await runRag2TypedFactExtractionEval(
      _optionsRag2TypedFactExtractionEval(directory.path),
    );
...
Rag2TypedFactExtractionOptions _optionsRag2TypedFactExtractionEval(
  String outDir,
