...
void _runRunFoundationModelsLiveCanary() {
  group('Foundation Models live canary runner', () {
    ...
    test(
      ...
      () async {
        final fixture = _ScriptFixtureRunFoundationModelsLiveCanary.create();
...
final class _ScriptFixtureRunFoundationModelsLiveCanary {
  _ScriptFixtureRunFoundationModelsLiveCanary._(this.root, this.bin);
  ...
  static _ScriptFixtureRunFoundationModelsLiveCanary create() {
    ...
    return _ScriptFixtureRunFoundationModelsLiveCanary._(root, bin);
  }

  void writeFlutter() {
    _writeExecutableRunFoundationModelsLiveCanary('flutter', '''
#!/usr/bin/env bash
{
  printf 'ARGS:%s\\n' "\$*"
...
''');
  ...
  void writeDart() {
    _writeExecutableRunFoundationModelsLiveCanary('dart', '''
#!/usr/bin/env bash
printf 'ARGS:%s\\n' "\$*" > "\${DART_LOG}"
exit 0
''');
  ...
  void _writeExecutableRunFoundationModelsLiveCanary(
    String name,
    String contents,
  ) {
