...
void _runRag2TypedFactExtractionV2HoldoutEval() {
  test('freezes an independent precision holdout for v1 and v2', () async {
    final fixture = await Rag2TypedFactExtractionPrecisionFixture.load(
      File(_fixturePathRag2TypedFactExtractionV2HoldoutEval),
    );
  ...
  test('promotes v2 precision while extraction remains no-go', () async {
    ...
    final report = await runRag2TypedFactExtractionV2HoldoutEval(
      _optionsRag2TypedFactExtractionV2HoldoutEval(directory.path),
    );
  ...
  test('rejects precision oracle provenance outside the corpus', () async {
    ...
    final json =
        jsonDecode(
              File(
                _oraclePathRag2TypedFactExtractionV2HoldoutEval,
              ).readAsStringSync(),
            )
    ...
    await expectLater(
      runRag2TypedFactExtractionV2HoldoutEval(
        Rag2TypedFactExtractionV2HoldoutOptions(
          fixturePath: _fixturePathRag2TypedFactExtractionV2HoldoutEval,
...
const _fixturePathRag2TypedFactExtractionV2HoldoutEval =
    'tool/fixtures/rag2_extraction_v2_holdout/fixture.json';
const _oraclePathRag2TypedFactExtractionV2HoldoutEval =
    'tool/fixtures/rag2_extraction_v2_holdout/oracle_facts.json';

Rag2TypedFactExtractionV2HoldoutOptions
_optionsRag2TypedFactExtractionV2HoldoutEval(String outDir) =>
    Rag2TypedFactExtractionV2HoldoutOptions(
      fixturePath: _fixturePathRag2TypedFactExtractionV2HoldoutEval,
      oracleFactsPath: _oraclePathRag2TypedFactExtractionV2HoldoutEval,
      outDir: outDir,
    );
