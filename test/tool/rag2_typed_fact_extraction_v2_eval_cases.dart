...
void _runRag2TypedFactExtractionV2Eval() {
  ...
  test('compares precision-only v2 across both frozen fixtures', () async {
    ...
    final report = await runRag2TypedFactExtractionV2Eval(
      _optionsRag2TypedFactExtractionV2Eval(directory.path),
    );
...
Rag2TypedFactExtractionV2Options _optionsRag2TypedFactExtractionV2Eval(
  String outDir,
