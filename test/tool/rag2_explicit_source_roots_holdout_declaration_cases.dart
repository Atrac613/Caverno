...
const _fixturePathRag2ExplicitSourceRootsHoldoutDeclaration =
    'tool/fixtures/rag2_explicit_source_roots_holdout_v1/declaration.json';

void _runRag2ExplicitSourceRootsHoldoutDeclaration() {
  test('freezes the promotion holdout declaration before questions', () {
    final fixture =
        jsonDecode(
              File(
                _fixturePathRag2ExplicitSourceRootsHoldoutDeclaration,
              ).readAsStringSync(),
            )
