...
void _runRag2TypedFactExtractionHoldoutEval() {
  test(
  ...
  test('audits frozen extraction v1 without downstream claims', () async {
    ...
    final report = await runRag2TypedFactExtractionHoldoutEval(
      _optionsRag2TypedFactExtractionHoldoutEval(directory.path),
    );
    ...
    await expectLater(
      runRag2TypedFactExtractionHoldoutEval(
        Rag2TypedFactExtractionHoldoutOptions(
          fixturePath: _fixturePathRag2TypedFactExtractionHoldoutEval,
...
const _fixturePathRag2TypedFactExtractionHoldoutEval =
    'tool/fixtures/rag2_extraction_holdout/fixture.json';
const _oraclePathRag2TypedFactExtractionHoldoutEval =
    'tool/fixtures/rag2_extraction_holdout/oracle_facts.json';

Rag2TypedFactExtractionHoldoutOptions
_optionsRag2TypedFactExtractionHoldoutEval(String outDir) =>
    Rag2TypedFactExtractionHoldoutOptions(
      fixturePath: _fixturePathRag2TypedFactExtractionHoldoutEval,
      oracleFactsPath: _oraclePathRag2TypedFactExtractionHoldoutEval,
      outDir: outDir,
    );
