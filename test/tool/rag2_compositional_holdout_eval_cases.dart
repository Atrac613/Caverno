...
void _runRag2CompositionalHoldoutEval() {
  test('compares frozen v1 and v2 on compositional controls', () async {
    ...
    final report = await runRag2CompositionalHoldoutComparison(
      _optionsRag2CompositionalHoldoutEval(directory.path),
    );
...
Rag2SemanticHoldoutOptions _optionsRag2CompositionalHoldoutEval(
  String outDir,
