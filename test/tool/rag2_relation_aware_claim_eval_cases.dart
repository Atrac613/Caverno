...
void _runRag2RelationAwareClaimEval() {
  ...
  test('compares v1 and v2 across both frozen suites', () async {
    ...
    final report = await runRag2RelationComparison(
      _optionsRag2RelationAwareClaimEval(directory.path),
    );
  ...
  test(
    ...
    () async {
      ...
      final report = await runRag2SemanticHoldoutEval(
        _optionsRag2RelationAwareClaimEval(
          directory.path,
        ).semanticOptions(directory.path),
...
Rag2RelationComparisonOptions _optionsRag2RelationAwareClaimEval(
  String outDir,
