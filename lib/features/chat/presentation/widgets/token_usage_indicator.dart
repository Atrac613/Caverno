...
class TokenUsageIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // The ring alone: which model is running is stated by the composer's own
    // model chip, so repeating it here was the same fact twice. What this
    // control adds is how full that model's context window is.
    return MenuAnchor(
