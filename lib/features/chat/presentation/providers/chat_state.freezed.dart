...
mixin _$ChatState {
 ...
 List<Message> get messages; bool get isLoading; String? get error; int get promptTokens; int get completionTokens; int get totalTokens; int get estimatedPromptTokens; ContextTokenPressureLevel get contextTokenPressureLevel; bool get promptCompactionActive;// SSH tool UI flow — holders contain Completers so they live outside
...
@override
int get hashCode => Object.hashAll([runtimeType,const DeepCollectionEquality().hash(messages),isLoading,error,promptTokens,completionTokens,totalTokens,estimatedPromptTokens,contextTokenPressureLevel,promptCompactionActive,pendingSshConnect,pendingSshCommand,pendingGitCommand,pendingLocalCommand,pendingComputerUseAction,pendingFileOperation,pendingBleConnect,pendingWorkflowDecision,isGeneratingWorkflowProposal,workflowProposalDraft,workflowProposalError,isGeneratingTaskProposal,taskProposalDraft,taskProposalError]);

@override
String toString() {
  return 'ChatState(messages: $messages, isLoading: $isLoading, error: $error, promptTokens: $promptTokens, completionTokens: $completionTokens, totalTokens: $totalTokens, estimatedPromptTokens: $estimatedPromptTokens, contextTokenPressureLevel: $contextTokenPressureLevel, promptCompactionActive: $promptCompactionActive, pendingSshConnect: $pendingSshConnect, pendingSshCommand: $pendingSshCommand, pendingGitCommand: $pendingGitCommand, pendingLocalCommand: $pendingLocalCommand, pendingComputerUseAction: $pendingComputerUseAction, pendingFileOperation: $pendingFileOperation, pendingBleConnect: $pendingBleConnect, pendingWorkflowDecision: $pendingWorkflowDecision, isGeneratingWorkflowProposal: $isGeneratingWorkflowProposal, workflowProposalDraft: $workflowProposalDraft, workflowProposalError: $workflowProposalError, isGeneratingTaskProposal: $isGeneratingTaskProposal, taskProposalDraft: $taskProposalDraft, taskProposalError: $taskProposalError)';
}
...
switch (_that) {
case _ChatState() when $default != null:
return $default(_that.messages,_that.isLoading,_that.error,_that.promptTokens,_that.completionTokens,_that.totalTokens,_that.estimatedPromptTokens,_that.contextTokenPressureLevel,_that.promptCompactionActive,_that.pendingSshConnect,_that.pendingSshCommand,_that.pendingGitCommand,_that.pendingLocalCommand,_that.pendingComputerUseAction,_that.pendingFileOperation,_that.pendingBleConnect,_that.pendingWorkflowDecision,_that.isGeneratingWorkflowProposal,_that.workflowProposalDraft,_that.workflowProposalError,_that.isGeneratingTaskProposal,_that.taskProposalDraft,_that.taskProposalError);case _:
  return orElse();
...
class _ChatState implements ChatState {
  const _ChatState({required final  List<Message> messages, required this.isLoading, this.error, this.promptTokens = 0, this.completionTokens = 0, this.totalTokens = 0, this.estimatedPromptTokens = 0, this.contextTokenPressureLevel = ContextTokenPressureLevel.normal, this.promptCompactionActive = false, this.pendingSshConnect, this.pendingSshCommand, this.pendingGitCommand, this.pendingLocalCommand, this.pendingComputerUseAction, this.pendingFileOperation, this.pendingBleConnect, this.pendingWorkflowDecision, this.isGeneratingWorkflowProposal = false, this.workflowProposalDraft, this.workflowProposalError, this.isGeneratingTaskProposal = false, this.taskProposalDraft, this.taskProposalError}): _messages = messages;
...
@override
int get hashCode => Object.hashAll([runtimeType,const DeepCollectionEquality().hash(_messages),isLoading,error,promptTokens,completionTokens,totalTokens,estimatedPromptTokens,contextTokenPressureLevel,promptCompactionActive,pendingSshConnect,pendingSshCommand,pendingGitCommand,pendingLocalCommand,pendingComputerUseAction,pendingFileOperation,pendingBleConnect,pendingWorkflowDecision,isGeneratingWorkflowProposal,workflowProposalDraft,workflowProposalError,isGeneratingTaskProposal,taskProposalDraft,taskProposalError]);
