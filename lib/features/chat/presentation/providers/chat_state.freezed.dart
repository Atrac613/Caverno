...
as PendingParticipantToolApproval?,pendingAssumptionConfirmation: freezed == pendingAssumptionConfirmation ? _self.pendingAssumptionConfirmation : pendingAssumptionConfirmation // ignore: cast_nullable_to_non_nullable
as PendingAssumptionConfirmation?,pendingAskUserQuestion: freezed == pendingAskUserQuestion ? _self.pendingAskUserQuestion : pendingAskUserQuestion // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Message> messages,  List<QueuedChatMessage> queuedMessages,  List<QueuedChatMessage> steeringMessages,  bool isLoading,  Set<String> busyConversationIds,  Set<String> approvalRequiredConversationIds,  String? error,  int promptTokens,  int completionTokens,  int totalTokens,  int estimatedPromptTokens,  ContextTokenPressureLevel contextTokenPressureLevel,  bool promptCompactionActive,  ContextSurgeryObservationSnapshot contextSurgerySnapshot,  ParticipantTurnRuntime? participantTurnRuntime,  PendingSshConnect? pendingSshConnect,  PendingSshCommand? pendingSshCommand,  PendingGitCommand? pendingGitCommand,  PendingLocalCommand? pendingLocalCommand,  PendingComputerUseAction? pendingComputerUseAction,  PendingBrowserAction? pendingBrowserAction,  PendingFileOperation? pendingFileOperation,  PendingBleConnect? pendingBleConnect,  PendingSerialOpen? pendingSerialOpen,  PendingParticipantToolApproval? pendingParticipantToolApproval,  PendingAssumptionConfirmation? pendingAssumptionConfirmation,  PendingAskUserQuestion? pendingAskUserQuestion,  PendingWorkflowDecision? pendingWorkflowDecision,  bool isGeneratingWorkflowProposal,  WorkflowProposalDraft? workflowProposalDraft,  String? workflowProposalError,  bool isGeneratingTaskProposal,  WorkflowTaskProposalDraft? taskProposalDraft,  String? taskProposalError,  int goalAutoContinueCount,  int goalAutoContinueBudget,  String? goalAutoContinueNotice)  $default,) {final _that = this;
switch (_that) {
case _ChatState():
return $default(_that.messages,_that.queuedMessages,_that.steeringMessages,_that.isLoading,_that.busyConversationIds,_that.approvalRequiredConversationIds,_that.error,_that.promptTokens,_that.completionTokens,_that.totalTokens,_that.estimatedPromptTokens,_that.contextTokenPressureLevel,_that.promptCompactionActive,_that.contextSurgerySnapshot,_that.participantTurnRuntime,_that.pendingSshConnect,_that.pendingSshCommand,_that.pendingGitCommand,_that.pendingLocalCommand,_that.pendingComputerUseAction,_that.pendingBrowserAction,_that.pendingFileOperation,_that.pendingBleConnect,_that.pendingSerialOpen,_that.pendingParticipantToolApproval,_that.pendingAssumptionConfirmation,_that.pendingAskUserQuestion,_that.pendingWorkflowDecision,_that.isGeneratingWorkflowProposal,_that.workflowProposalDraft,_that.workflowProposalError,_that.isGeneratingTaskProposal,_that.taskProposalDraft,_that.taskProposalError,_that.goalAutoContinueCount,_that.goalAutoContinueBudget,_that.goalAutoContinueNotice);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Message> messages,  List<QueuedChatMessage> queuedMessages,  List<QueuedChatMessage> steeringMessages,  bool isLoading,  Set<String> busyConversationIds,  Set<String> approvalRequiredConversationIds,  String? error,  int promptTokens,  int completionTokens,  int totalTokens,  int estimatedPromptTokens,  ContextTokenPressureLevel contextTokenPressureLevel,  bool promptCompactionActive,  ContextSurgeryObservationSnapshot contextSurgerySnapshot,  ParticipantTurnRuntime? participantTurnRuntime,  PendingSshConnect? pendingSshConnect,  PendingSshCommand? pendingSshCommand,  PendingGitCommand? pendingGitCommand,  PendingLocalCommand? pendingLocalCommand,  PendingComputerUseAction? pendingComputerUseAction,  PendingBrowserAction? pendingBrowserAction,  PendingFileOperation? pendingFileOperation,  PendingBleConnect? pendingBleConnect,  PendingSerialOpen? pendingSerialOpen,  PendingParticipantToolApproval? pendingParticipantToolApproval,  PendingAssumptionConfirmation? pendingAssumptionConfirmation,  PendingAskUserQuestion? pendingAskUserQuestion,  PendingWorkflowDecision? pendingWorkflowDecision,  bool isGeneratingWorkflowProposal,  WorkflowProposalDraft? workflowProposalDraft,  String? workflowProposalError,  bool isGeneratingTaskProposal,  WorkflowTaskProposalDraft? taskProposalDraft,  String? taskProposalError,  int goalAutoContinueCount,  int goalAutoContinueBudget,  String? goalAutoContinueNotice)?  $default,) {final _that = this;
switch (_that) {
case _ChatState() when $default != null:
return $default(_that.messages,_that.queuedMessages,_that.steeringMessages,_that.isLoading,_that.busyConversationIds,_that.approvalRequiredConversationIds,_that.error,_that.promptTokens,_that.completionTokens,_that.totalTokens,_that.estimatedPromptTokens,_that.contextTokenPressureLevel,_that.promptCompactionActive,_that.contextSurgerySnapshot,_that.participantTurnRuntime,_that.pendingSshConnect,_that.pendingSshCommand,_that.pendingGitCommand,_that.pendingLocalCommand,_that.pendingComputerUseAction,_that.pendingBrowserAction,_that.pendingFileOperation,_that.pendingBleConnect,_that.pendingSerialOpen,_that.pendingParticipantToolApproval,_that.pendingAssumptionConfirmation,_that.pendingAskUserQuestion,_that.pendingWorkflowDecision,_that.isGeneratingWorkflowProposal,_that.workflowProposalDraft,_that.workflowProposalError,_that.isGeneratingTaskProposal,_that.taskProposalDraft,_that.taskProposalError,_that.goalAutoContinueCount,_that.goalAutoContinueBudget,_that.goalAutoContinueNotice);case _:
  return null;
...
@override@JsonKey() List<QueuedChatMessage> get steeringMessages {
  ...
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_steeringMessages);
}
...
as List<QueuedChatMessage>,steeringMessages: null == steeringMessages ? _self._steeringMessages : steeringMessages // ignore: cast_nullable_to_non_nullable
as List<QueuedChatMessage>,isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
