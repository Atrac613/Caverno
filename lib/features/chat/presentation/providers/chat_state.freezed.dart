...
// the freezed equality graph.
 ...
 PendingComputerUseAction? get pendingComputerUseAction;// File mutation tool UI flow.
 PendingFileOperation? get pendingFileOperation;// BLE tool UI flow — same Completer-based pattern as SSH.
 PendingBleConnect? get pendingBleConnect;// Generic model-initiated question UI flow.
...
@override
int get hashCode => Object.hashAll([runtimeType,const DeepCollectionEquality().hash(messages),const DeepCollectionEquality().hash(queuedMessages),isLoading,error,promptTokens,completionTokens,totalTokens,estimatedPromptTokens,contextTokenPressureLevel,promptCompactionActive,pendingSshConnect,pendingSshCommand,pendingGitCommand,pendingLocalCommand,pendingComputerUseAction,pendingFileOperation,pendingBleConnect,pendingAskUserQuestion,pendingWorkflowDecision,isGeneratingWorkflowProposal,workflowProposalDraft,workflowProposalError,isGeneratingTaskProposal,taskProposalDraft,taskProposalError]);

@override
String toString() {
  return 'ChatState(messages: $messages, queuedMessages: $queuedMessages, isLoading: $isLoading, error: $error, promptTokens: $promptTokens, completionTokens: $completionTokens, totalTokens: $totalTokens, estimatedPromptTokens: $estimatedPromptTokens, contextTokenPressureLevel: $contextTokenPressureLevel, promptCompactionActive: $promptCompactionActive, pendingSshConnect: $pendingSshConnect, pendingSshCommand: $pendingSshCommand, pendingGitCommand: $pendingGitCommand, pendingLocalCommand: $pendingLocalCommand, pendingComputerUseAction: $pendingComputerUseAction, pendingFileOperation: $pendingFileOperation, pendingBleConnect: $pendingBleConnect, pendingAskUserQuestion: $pendingAskUserQuestion, pendingWorkflowDecision: $pendingWorkflowDecision, isGeneratingWorkflowProposal: $isGeneratingWorkflowProposal, workflowProposalDraft: $workflowProposalDraft, workflowProposalError: $workflowProposalError, isGeneratingTaskProposal: $isGeneratingTaskProposal, taskProposalDraft: $taskProposalDraft, taskProposalError: $taskProposalError)';
}
...
@useResult
$Res call({
 List<Message> messages, List<QueuedChatMessage> queuedMessages, bool isLoading, String? error, int promptTokens, int completionTokens, int totalTokens, int estimatedPromptTokens, ContextTokenPressureLevel contextTokenPressureLevel, bool promptCompactionActive, PendingSshConnect? pendingSshConnect, PendingSshCommand? pendingSshCommand, PendingGitCommand? pendingGitCommand, PendingLocalCommand? pendingLocalCommand, PendingComputerUseAction? pendingComputerUseAction, PendingFileOperation? pendingFileOperation, PendingBleConnect? pendingBleConnect, PendingAskUserQuestion? pendingAskUserQuestion, PendingWorkflowDecision? pendingWorkflowDecision, bool isGeneratingWorkflowProposal, WorkflowProposalDraft? workflowProposalDraft, String? workflowProposalError, bool isGeneratingTaskProposal, WorkflowTaskProposalDraft? taskProposalDraft, String? taskProposalError
});
...
as bool,pendingSshConnect: freezed == pendingSshConnect ? _self.pendingSshConnect : pendingSshConnect // ignore: cast_nullable_to_non_nullable
...
as PendingComputerUseAction?,pendingFileOperation: freezed == pendingFileOperation ? _self.pendingFileOperation : pendingFileOperation // ignore: cast_nullable_to_non_nullable
...
as PendingBleConnect?,pendingAskUserQuestion: freezed == pendingAskUserQuestion ? _self.pendingAskUserQuestion : pendingAskUserQuestion // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ChatState() when $default != null:
return $default(_that.messages,_that.queuedMessages,_that.isLoading,_that.error,_that.promptTokens,_that.completionTokens,_that.totalTokens,_that.estimatedPromptTokens,_that.contextTokenPressureLevel,_that.promptCompactionActive,_that.pendingSshConnect,_that.pendingSshCommand,_that.pendingGitCommand,_that.pendingLocalCommand,_that.pendingComputerUseAction,_that.pendingFileOperation,_that.pendingBleConnect,_that.pendingAskUserQuestion,_that.pendingWorkflowDecision,_that.isGeneratingWorkflowProposal,_that.workflowProposalDraft,_that.workflowProposalError,_that.isGeneratingTaskProposal,_that.taskProposalDraft,_that.taskProposalError);case _:
  return orElse();
