...
// the freezed equality graph.
 ...
 PendingBleConnect? get pendingBleConnect; bool get isGeneratingWorkflowProposal; WorkflowProposalDraft? get workflowProposalDraft; String? get workflowProposalError; bool get isGeneratingTaskProposal; WorkflowTaskProposalDraft? get taskProposalDraft; String? get taskProposalError;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(messages),isLoading,error,promptTokens,completionTokens,totalTokens,pendingSshConnect,pendingSshCommand,pendingGitCommand,pendingLocalCommand,pendingFileOperation,pendingBleConnect,isGeneratingWorkflowProposal,workflowProposalDraft,workflowProposalError,isGeneratingTaskProposal,taskProposalDraft,taskProposalError);

@override
String toString() {
  return 'ChatState(messages: $messages, isLoading: $isLoading, error: $error, promptTokens: $promptTokens, completionTokens: $completionTokens, totalTokens: $totalTokens, pendingSshConnect: $pendingSshConnect, pendingSshCommand: $pendingSshCommand, pendingGitCommand: $pendingGitCommand, pendingLocalCommand: $pendingLocalCommand, pendingFileOperation: $pendingFileOperation, pendingBleConnect: $pendingBleConnect, isGeneratingWorkflowProposal: $isGeneratingWorkflowProposal, workflowProposalDraft: $workflowProposalDraft, workflowProposalError: $workflowProposalError, isGeneratingTaskProposal: $isGeneratingTaskProposal, taskProposalDraft: $taskProposalDraft, taskProposalError: $taskProposalError)';
}
...
as PendingBleConnect?,isGeneratingWorkflowProposal: null == isGeneratingWorkflowProposal ? _self.isGeneratingWorkflowProposal : isGeneratingWorkflowProposal // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ChatState() when $default != null:
return $default(_that.messages,_that.isLoading,_that.error,_that.promptTokens,_that.completionTokens,_that.totalTokens,_that.pendingSshConnect,_that.pendingSshCommand,_that.pendingGitCommand,_that.pendingLocalCommand,_that.pendingFileOperation,_that.pendingBleConnect,_that.isGeneratingWorkflowProposal,_that.workflowProposalDraft,_that.workflowProposalError,_that.isGeneratingTaskProposal,_that.taskProposalDraft,_that.taskProposalError);case _:
  return orElse();
...
class _ChatState implements ChatState {
  const _ChatState({required final  List<Message> messages, required this.isLoading, this.error, this.promptTokens = 0, this.completionTokens = 0, this.totalTokens = 0, this.pendingSshConnect, this.pendingSshCommand, this.pendingGitCommand, this.pendingLocalCommand, this.pendingFileOperation, this.pendingBleConnect, this.isGeneratingWorkflowProposal = false, this.workflowProposalDraft, this.workflowProposalError, this.isGeneratingTaskProposal = false, this.taskProposalDraft, this.taskProposalError}): _messages = messages;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_messages),isLoading,error,promptTokens,completionTokens,totalTokens,pendingSshConnect,pendingSshCommand,pendingGitCommand,pendingLocalCommand,pendingFileOperation,pendingBleConnect,isGeneratingWorkflowProposal,workflowProposalDraft,workflowProposalError,isGeneratingTaskProposal,taskProposalDraft,taskProposalError);
