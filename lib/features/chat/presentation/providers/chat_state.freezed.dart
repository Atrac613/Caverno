...
mixin _$ChatState {
 ...
 List<Message> get messages; List<QueuedChatMessage> get queuedMessages; bool get isLoading;// Conversations with a running response, including ones the user is not
...
@useResult
$Res call({
 List<Message> messages, List<QueuedChatMessage> queuedMessages, bool isLoading, Set<String> busyConversationIds, Set<String> approvalRequiredConversationIds, String? error, int promptTokens, int completionTokens, int totalTokens, int estimatedPromptTokens, ContextTokenPressureLevel contextTokenPressureLevel, bool promptCompactionActive, ContextSurgeryObservationSnapshot contextSurgerySnapshot, ParticipantTurnRuntime? participantTurnRuntime, PendingSshConnect? pendingSshConnect, PendingSshCommand? pendingSshCommand, PendingGitCommand? pendingGitCommand, PendingLocalCommand? pendingLocalCommand, PendingComputerUseAction? pendingComputerUseAction, PendingBrowserAction? pendingBrowserAction, PendingFileOperation? pendingFileOperation, PendingBleConnect? pendingBleConnect, PendingSerialOpen? pendingSerialOpen, PendingParticipantToolApproval? pendingParticipantToolApproval, PendingAskUserQuestion? pendingAskUserQuestion, PendingWorkflowDecision? pendingWorkflowDecision, bool isGeneratingWorkflowProposal, WorkflowProposalDraft? workflowProposalDraft, String? workflowProposalError, bool isGeneratingTaskProposal, WorkflowTaskProposalDraft? taskProposalDraft, String? taskProposalError, int goalAutoContinueCount, int goalAutoContinueBudget, String? goalAutoContinueNotice
});
...
as bool,busyConversationIds: null == busyConversationIds ? _self.busyConversationIds : busyConversationIds // ignore: cast_nullable_to_non_nullable
as Set<String>,approvalRequiredConversationIds: null == approvalRequiredConversationIds ? _self.approvalRequiredConversationIds : approvalRequiredConversationIds // ignore: cast_nullable_to_non_nullable
...
as String?,goalAutoContinueCount: null == goalAutoContinueCount ? _self.goalAutoContinueCount : goalAutoContinueCount // ignore: cast_nullable_to_non_nullable
as int,goalAutoContinueBudget: null == goalAutoContinueBudget ? _self.goalAutoContinueBudget : goalAutoContinueBudget // ignore: cast_nullable_to_non_nullable
as int,goalAutoContinueNotice: freezed == goalAutoContinueNotice ? _self.goalAutoContinueNotice : goalAutoContinueNotice // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of ChatState
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Message> messages,  List<QueuedChatMessage> queuedMessages,  bool isLoading,  Set<String> busyConversationIds,  Set<String> approvalRequiredConversationIds,  String? error,  int promptTokens,  int completionTokens,  int totalTokens,  int estimatedPromptTokens,  ContextTokenPressureLevel contextTokenPressureLevel,  bool promptCompactionActive,  ContextSurgeryObservationSnapshot contextSurgerySnapshot,  ParticipantTurnRuntime? participantTurnRuntime,  PendingSshConnect? pendingSshConnect,  PendingSshCommand? pendingSshCommand,  PendingGitCommand? pendingGitCommand,  PendingLocalCommand? pendingLocalCommand,  PendingComputerUseAction? pendingComputerUseAction,  PendingBrowserAction? pendingBrowserAction,  PendingFileOperation? pendingFileOperation,  PendingBleConnect? pendingBleConnect,  PendingSerialOpen? pendingSerialOpen,  PendingParticipantToolApproval? pendingParticipantToolApproval,  PendingAskUserQuestion? pendingAskUserQuestion,  PendingWorkflowDecision? pendingWorkflowDecision,  bool isGeneratingWorkflowProposal,  WorkflowProposalDraft? workflowProposalDraft,  String? workflowProposalError,  bool isGeneratingTaskProposal,  WorkflowTaskProposalDraft? taskProposalDraft,  String? taskProposalError,  int goalAutoContinueCount,  int goalAutoContinueBudget,  String? goalAutoContinueNotice)  $default,) {final _that = this;
switch (_that) {
case _ChatState():
return $default(_that.messages,_that.queuedMessages,_that.isLoading,_that.busyConversationIds,_that.approvalRequiredConversationIds,_that.error,_that.promptTokens,_that.completionTokens,_that.totalTokens,_that.estimatedPromptTokens,_that.contextTokenPressureLevel,_that.promptCompactionActive,_that.contextSurgerySnapshot,_that.participantTurnRuntime,_that.pendingSshConnect,_that.pendingSshCommand,_that.pendingGitCommand,_that.pendingLocalCommand,_that.pendingComputerUseAction,_that.pendingBrowserAction,_that.pendingFileOperation,_that.pendingBleConnect,_that.pendingSerialOpen,_that.pendingParticipantToolApproval,_that.pendingAskUserQuestion,_that.pendingWorkflowDecision,_that.isGeneratingWorkflowProposal,_that.workflowProposalDraft,_that.workflowProposalError,_that.isGeneratingTaskProposal,_that.taskProposalDraft,_that.taskProposalError,_that.goalAutoContinueCount,_that.goalAutoContinueBudget,_that.goalAutoContinueNotice);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Message> messages,  List<QueuedChatMessage> queuedMessages,  bool isLoading,  Set<String> busyConversationIds,  Set<String> approvalRequiredConversationIds,  String? error,  int promptTokens,  int completionTokens,  int totalTokens,  int estimatedPromptTokens,  ContextTokenPressureLevel contextTokenPressureLevel,  bool promptCompactionActive,  ContextSurgeryObservationSnapshot contextSurgerySnapshot,  ParticipantTurnRuntime? participantTurnRuntime,  PendingSshConnect? pendingSshConnect,  PendingSshCommand? pendingSshCommand,  PendingGitCommand? pendingGitCommand,  PendingLocalCommand? pendingLocalCommand,  PendingComputerUseAction? pendingComputerUseAction,  PendingBrowserAction? pendingBrowserAction,  PendingFileOperation? pendingFileOperation,  PendingBleConnect? pendingBleConnect,  PendingSerialOpen? pendingSerialOpen,  PendingParticipantToolApproval? pendingParticipantToolApproval,  PendingAskUserQuestion? pendingAskUserQuestion,  PendingWorkflowDecision? pendingWorkflowDecision,  bool isGeneratingWorkflowProposal,  WorkflowProposalDraft? workflowProposalDraft,  String? workflowProposalError,  bool isGeneratingTaskProposal,  WorkflowTaskProposalDraft? taskProposalDraft,  String? taskProposalError,  int goalAutoContinueCount,  int goalAutoContinueBudget,  String? goalAutoContinueNotice)?  $default,) {final _that = this;
switch (_that) {
case _ChatState() when $default != null:
return $default(_that.messages,_that.queuedMessages,_that.isLoading,_that.busyConversationIds,_that.approvalRequiredConversationIds,_that.error,_that.promptTokens,_that.completionTokens,_that.totalTokens,_that.estimatedPromptTokens,_that.contextTokenPressureLevel,_that.promptCompactionActive,_that.contextSurgerySnapshot,_that.participantTurnRuntime,_that.pendingSshConnect,_that.pendingSshCommand,_that.pendingGitCommand,_that.pendingLocalCommand,_that.pendingComputerUseAction,_that.pendingBrowserAction,_that.pendingFileOperation,_that.pendingBleConnect,_that.pendingSerialOpen,_that.pendingParticipantToolApproval,_that.pendingAskUserQuestion,_that.pendingWorkflowDecision,_that.isGeneratingWorkflowProposal,_that.workflowProposalDraft,_that.workflowProposalError,_that.isGeneratingTaskProposal,_that.taskProposalDraft,_that.taskProposalError,_that.goalAutoContinueCount,_that.goalAutoContinueBudget,_that.goalAutoContinueNotice);case _:
  return null;
...
@override@JsonKey() Set<String> get approvalRequiredConversationIds {
  ...
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableSetView(_approvalRequiredConversationIds);
}
...
@override@JsonKey() final  int goalAutoContinueCount;
@override@JsonKey() final  int goalAutoContinueBudget;
@override final  String? goalAutoContinueNotice;
...
@override
int get hashCode => Object.hashAll([runtimeType,const DeepCollectionEquality().hash(_messages),const DeepCollectionEquality().hash(_queuedMessages),isLoading,const DeepCollectionEquality().hash(_busyConversationIds),const DeepCollectionEquality().hash(_approvalRequiredConversationIds),error,promptTokens,completionTokens,totalTokens,estimatedPromptTokens,contextTokenPressureLevel,promptCompactionActive,contextSurgerySnapshot,participantTurnRuntime,pendingSshConnect,pendingSshCommand,pendingGitCommand,pendingLocalCommand,pendingComputerUseAction,pendingBrowserAction,pendingFileOperation,pendingBleConnect,pendingSerialOpen,pendingParticipantToolApproval,pendingAskUserQuestion,pendingWorkflowDecision,isGeneratingWorkflowProposal,workflowProposalDraft,workflowProposalError,isGeneratingTaskProposal,taskProposalDraft,taskProposalError,goalAutoContinueCount,goalAutoContinueBudget,goalAutoContinueNotice]);
...
as List<QueuedChatMessage>,isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool,busyConversationIds: null == busyConversationIds ? _self._busyConversationIds : busyConversationIds // ignore: cast_nullable_to_non_nullable
as Set<String>,approvalRequiredConversationIds: null == approvalRequiredConversationIds ? _self._approvalRequiredConversationIds : approvalRequiredConversationIds // ignore: cast_nullable_to_non_nullable
as Set<String>,error: freezed == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
as String?,promptTokens: null == promptTokens ? _self.promptTokens : promptTokens // ignore: cast_nullable_to_non_nullable
as int,completionTokens: null == completionTokens ? _self.completionTokens : completionTokens // ignore: cast_nullable_to_non_nullable
as int,totalTokens: null == totalTokens ? _self.totalTokens : totalTokens // ignore: cast_nullable_to_non_nullable
