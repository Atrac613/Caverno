...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,title,prompt,codingProjectId,baseBranch,branchName,worktreePath,checkpointLineageId,endpointId,verificationCommand,const DeepCollectionEquality().hash(objectiveAcceptanceCriteria),createdAt,updatedAt,startedAt,finishedAt,resultSummary,verifiedGreen,verificationSummary,const DeepCollectionEquality().hash(changedFiles),changedFileEvidenceTruncated,recoveryNote,error]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,title,prompt,codingProjectId,baseBranch,branchName,worktreePath,checkpointLineageId,endpointId,verificationCommand,const DeepCollectionEquality().hash(_objectiveAcceptanceCriteria),createdAt,updatedAt,startedAt,finishedAt,resultSummary,verifiedGreen,verificationSummary,const DeepCollectionEquality().hash(_changedFiles),changedFileEvidenceTruncated,recoveryNote,error]);
