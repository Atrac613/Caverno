...
/// accepted.
 String get workflowTaskId; String get baseBranch; String get branchName; String get worktreePath; String get checkpointLineageId; String get endpointId; String get verificationCommand;/// The files the saved task said it would change.
///
...
as String,expectedTargetFiles: null == expectedTargetFiles ? _self.expectedTargetFiles : expectedTargetFiles // ignore: cast_nullable_to_non_nullable
as List<String>,objectiveAcceptanceCriteria: null == objectiveAcceptanceCriteria ? _self.objectiveAcceptanceCriteria : objectiveAcceptanceCriteria // ignore: cast_nullable_to_non_nullable
...
/// files owes no changed-file evidence, which is the rule the subagent side
/// already had for an inspecting child.
 final  List<String> _expectedTargetFiles;
/// The files the saved task said it would change.
///
/// Carried so the audit can tell "changed nothing, as expected" from
/// "changed nothing, and said it would": a task that declares no target
/// files owes no changed-file evidence, which is the rule the subagent side
/// already had for an inspecting child.
@override@JsonKey() List<String> get expectedTargetFiles {
  if (_expectedTargetFiles is EqualUnmodifiableListView) return _expectedTargetFiles;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_expectedTargetFiles);
}
...
as String,endpointId: null == endpointId ? _self.endpointId : endpointId // ignore: cast_nullable_to_non_nullable
as String,verificationCommand: null == verificationCommand ? _self.verificationCommand : verificationCommand // ignore: cast_nullable_to_non_nullable
as String,expectedTargetFiles: null == expectedTargetFiles ? _self._expectedTargetFiles : expectedTargetFiles // ignore: cast_nullable_to_non_nullable
as List<String>,objectiveAcceptanceCriteria: null == objectiveAcceptanceCriteria ? _self._objectiveAcceptanceCriteria : objectiveAcceptanceCriteria // ignore: cast_nullable_to_non_nullable
as List<String>,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,startedAt: freezed == startedAt ? _self.startedAt : startedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,finishedAt: freezed == finishedAt ? _self.finishedAt : finishedAt // ignore: cast_nullable_to_non_nullable
