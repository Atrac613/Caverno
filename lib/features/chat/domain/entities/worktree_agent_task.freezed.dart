...
mixin _$WorktreeAgentTask {
 ...
 String get id;@JsonKey(unknownEnumValue: WorktreeAgentTaskStatus.needsRecovery) WorktreeAgentTaskStatus get status; String get title; String get prompt; String get codingProjectId;/// The saved plan task this worktree child was admitted against.
///
...
/// accepted.
 String get workflowTaskId; String get baseBranch; String get branchName; String get worktreePath; String get checkpointLineageId; String get endpointId; String get verificationCommand; List<String> get objectiveAcceptanceCriteria; DateTime get createdAt; DateTime get updatedAt; DateTime? get startedAt; DateTime? get finishedAt; String get resultSummary; bool get verifiedGreen; String get verificationSummary; List<WorktreeAgentChangedFileEvidence> get changedFiles; bool get changedFileEvidenceTruncated; String get recoveryNote; String get error;
...
switch (_that) {
case _WorktreeAgentTask() when $default != null:
return $default(_that.id,_that.status,_that.title,_that.prompt,_that.codingProjectId,_that.workflowTaskId,_that.baseBranch,_that.branchName,_that.worktreePath,_that.checkpointLineageId,_that.endpointId,_that.verificationCommand,_that.objectiveAcceptanceCriteria,_that.createdAt,_that.updatedAt,_that.startedAt,_that.finishedAt,_that.resultSummary,_that.verifiedGreen,_that.verificationSummary,_that.changedFiles,_that.changedFileEvidenceTruncated,_that.recoveryNote,_that.error);case _:
  return orElse();
