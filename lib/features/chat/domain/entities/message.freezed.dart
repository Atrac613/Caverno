...
mixin _$Message {
 ...
 String get id; String get content;/// Content sent to the model when it differs from [content].
///
...
/// follow-up turns.
 String? get modelContent; MessageRole get role; DateTime get timestamp; bool get isStreaming; String? get error; String? get imageBase64; String? get imageMimeType;/// True when Caverno composed this message rather than the person.
///
...
/// latest user message and carried no image.
 bool get isSynthesizedPrompt;/// True when the Anabasis parent answered this turn.
///
...
/// participant would mix the two.
 bool get isAnabasisParent; String? get originalImagePath; String? get originalImageMimeType;/// Durable copy of a file attachment, kept out of band.
///
...
/// reader has to tolerate the file being gone.
 String? get attachmentPath;/// Video attachment, kept out of band.
///
...
@useResult
$Res call({
 String id, String content, String? modelContent, MessageRole role, DateTime timestamp, bool isStreaming, String? error, String? imageBase64, String? imageMimeType, bool isSynthesizedPrompt, bool isAnabasisParent, String? originalImagePath, String? originalImageMimeType, String? attachmentPath, String? videoPath, String? videoUrl, String? videoMimeType, int? videoSizeBytes, int? videoDurationMs, String? participantId, String? participantDisplayName, String? participantRoleLabel, int? participantColorValue, List<String> participantToolNames, String? handoffTargetParticipantId, String? handoffTargetDisplayName, String? handoffTargetRoleLabel, MessageResponseMetrics? responseMetrics
});
...
/// Create a copy of Message
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? content = null,Object? modelContent = freezed,Object? role = null,Object? timestamp = null,Object? isStreaming = null,Object? error = freezed,Object? imageBase64 = freezed,Object? imageMimeType = freezed,Object? isSynthesizedPrompt = null,Object? isAnabasisParent = null,Object? originalImagePath = freezed,Object? originalImageMimeType = freezed,Object? attachmentPath = freezed,Object? videoPath = freezed,Object? videoUrl = freezed,Object? videoMimeType = freezed,Object? videoSizeBytes = freezed,Object? videoDurationMs = freezed,Object? participantId = freezed,Object? participantDisplayName = freezed,Object? participantRoleLabel = freezed,Object? participantColorValue = freezed,Object? participantToolNames = null,Object? handoffTargetParticipantId = freezed,Object? handoffTargetDisplayName = freezed,Object? handoffTargetRoleLabel = freezed,Object? responseMetrics = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,content: null == content ? _self.content : content // ignore: cast_nullable_to_non_nullable
as String,modelContent: freezed == modelContent ? _self.modelContent : modelContent // ignore: cast_nullable_to_non_nullable
...
as bool,isAnabasisParent: null == isAnabasisParent ? _self.isAnabasisParent : isAnabasisParent // ignore: cast_nullable_to_non_nullable
...
as String?,videoMimeType: freezed == videoMimeType ? _self.videoMimeType : videoMimeType // ignore: cast_nullable_to_non_nullable
as String?,videoSizeBytes: freezed == videoSizeBytes ? _self.videoSizeBytes : videoSizeBytes // ignore: cast_nullable_to_non_nullable
as int?,videoDurationMs: freezed == videoDurationMs ? _self.videoDurationMs : videoDurationMs // ignore: cast_nullable_to_non_nullable
as int?,participantId: freezed == participantId ? _self.participantId : participantId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String content,  String? modelContent,  MessageRole role,  DateTime timestamp,  bool isStreaming,  String? error,  String? imageBase64,  String? imageMimeType,  bool isSynthesizedPrompt,  bool isAnabasisParent,  String? originalImagePath,  String? originalImageMimeType,  String? attachmentPath,  String? videoPath,  String? videoUrl,  String? videoMimeType,  int? videoSizeBytes,  int? videoDurationMs,  String? participantId,  String? participantDisplayName,  String? participantRoleLabel,  int? participantColorValue,  List<String> participantToolNames,  String? handoffTargetParticipantId,  String? handoffTargetDisplayName,  String? handoffTargetRoleLabel,  MessageResponseMetrics? responseMetrics)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Message() when $default != null:
return $default(_that.id,_that.content,_that.modelContent,_that.role,_that.timestamp,_that.isStreaming,_that.error,_that.imageBase64,_that.imageMimeType,_that.isSynthesizedPrompt,_that.isAnabasisParent,_that.originalImagePath,_that.originalImageMimeType,_that.attachmentPath,_that.videoPath,_that.videoUrl,_that.videoMimeType,_that.videoSizeBytes,_that.videoDurationMs,_that.participantId,_that.participantDisplayName,_that.participantRoleLabel,_that.participantColorValue,_that.participantToolNames,_that.handoffTargetParticipantId,_that.handoffTargetDisplayName,_that.handoffTargetRoleLabel,_that.responseMetrics);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String content,  String? modelContent,  MessageRole role,  DateTime timestamp,  bool isStreaming,  String? error,  String? imageBase64,  String? imageMimeType,  bool isSynthesizedPrompt,  bool isAnabasisParent,  String? originalImagePath,  String? originalImageMimeType,  String? attachmentPath,  String? videoPath,  String? videoUrl,  String? videoMimeType,  int? videoSizeBytes,  int? videoDurationMs,  String? participantId,  String? participantDisplayName,  String? participantRoleLabel,  int? participantColorValue,  List<String> participantToolNames,  String? handoffTargetParticipantId,  String? handoffTargetDisplayName,  String? handoffTargetRoleLabel,  MessageResponseMetrics? responseMetrics)  $default,) {final _that = this;
switch (_that) {
case _Message():
return $default(_that.id,_that.content,_that.modelContent,_that.role,_that.timestamp,_that.isStreaming,_that.error,_that.imageBase64,_that.imageMimeType,_that.isSynthesizedPrompt,_that.isAnabasisParent,_that.originalImagePath,_that.originalImageMimeType,_that.attachmentPath,_that.videoPath,_that.videoUrl,_that.videoMimeType,_that.videoSizeBytes,_that.videoDurationMs,_that.participantId,_that.participantDisplayName,_that.participantRoleLabel,_that.participantColorValue,_that.participantToolNames,_that.handoffTargetParticipantId,_that.handoffTargetDisplayName,_that.handoffTargetRoleLabel,_that.responseMetrics);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String content,  String? modelContent,  MessageRole role,  DateTime timestamp,  bool isStreaming,  String? error,  String? imageBase64,  String? imageMimeType,  bool isSynthesizedPrompt,  bool isAnabasisParent,  String? originalImagePath,  String? originalImageMimeType,  String? attachmentPath,  String? videoPath,  String? videoUrl,  String? videoMimeType,  int? videoSizeBytes,  int? videoDurationMs,  String? participantId,  String? participantDisplayName,  String? participantRoleLabel,  int? participantColorValue,  List<String> participantToolNames,  String? handoffTargetParticipantId,  String? handoffTargetDisplayName,  String? handoffTargetRoleLabel,  MessageResponseMetrics? responseMetrics)?  $default,) {final _that = this;
switch (_that) {
case _Message() when $default != null:
return $default(_that.id,_that.content,_that.modelContent,_that.role,_that.timestamp,_that.isStreaming,_that.error,_that.imageBase64,_that.imageMimeType,_that.isSynthesizedPrompt,_that.isAnabasisParent,_that.originalImagePath,_that.originalImageMimeType,_that.attachmentPath,_that.videoPath,_that.videoUrl,_that.videoMimeType,_that.videoSizeBytes,_that.videoDurationMs,_that.participantId,_that.participantDisplayName,_that.participantRoleLabel,_that.participantColorValue,_that.participantToolNames,_that.handoffTargetParticipantId,_that.handoffTargetDisplayName,_that.handoffTargetRoleLabel,_that.responseMetrics);case _:
  return null;
...
class _Message implements Message {
  const _Message({required this.id, required this.content, this.modelContent, required this.role, required this.timestamp, this.isStreaming = false, this.error, this.imageBase64, this.imageMimeType, this.isSynthesizedPrompt = false, this.isAnabasisParent = false, this.originalImagePath, this.originalImageMimeType, this.attachmentPath, this.videoPath, this.videoUrl, this.videoMimeType, this.videoSizeBytes, this.videoDurationMs, this.participantId, this.participantDisplayName, this.participantRoleLabel, this.participantColorValue, final  List<String> participantToolNames = const <String>[], this.handoffTargetParticipantId, this.handoffTargetDisplayName, this.handoffTargetRoleLabel, this.responseMetrics}): _participantToolNames = participantToolNames;
...
/// this field preserves the complete request across persistence and
/// follow-up turns.
@override final  String? modelContent;
...
/// keeps the parent's authority off surface identity, and rendering it as a
/// participant would mix the two.
@override@JsonKey() final  bool isAnabasisParent;
...
@override final  String? videoMimeType;
@override final  int? videoSizeBytes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,content,modelContent,role,timestamp,isStreaming,error,imageBase64,imageMimeType,isSynthesizedPrompt,isAnabasisParent,originalImagePath,originalImageMimeType,attachmentPath,videoPath,videoUrl,videoMimeType,videoSizeBytes,videoDurationMs,participantId,participantDisplayName,participantRoleLabel,participantColorValue,const DeepCollectionEquality().hash(_participantToolNames),handoffTargetParticipantId,handoffTargetDisplayName,handoffTargetRoleLabel,responseMetrics]);
...
/// Create a copy of Message
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? content = null,Object? modelContent = freezed,Object? role = null,Object? timestamp = null,Object? isStreaming = null,Object? error = freezed,Object? imageBase64 = freezed,Object? imageMimeType = freezed,Object? isSynthesizedPrompt = null,Object? isAnabasisParent = null,Object? originalImagePath = freezed,Object? originalImageMimeType = freezed,Object? attachmentPath = freezed,Object? videoPath = freezed,Object? videoUrl = freezed,Object? videoMimeType = freezed,Object? videoSizeBytes = freezed,Object? videoDurationMs = freezed,Object? participantId = freezed,Object? participantDisplayName = freezed,Object? participantRoleLabel = freezed,Object? participantColorValue = freezed,Object? participantToolNames = null,Object? handoffTargetParticipantId = freezed,Object? handoffTargetDisplayName = freezed,Object? handoffTargetRoleLabel = freezed,Object? responseMetrics = freezed,}) {
