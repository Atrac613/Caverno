...
/// latest user message and carried no image.
 bool get isSynthesizedPrompt; String? get originalImagePath; String? get originalImageMimeType;/// Video attachment, kept out of band.
///
...
switch (_that) {
case _Message() when $default != null:
return $default(_that.id,_that.content,_that.modelContent,_that.role,_that.timestamp,_that.isStreaming,_that.error,_that.imageBase64,_that.imageMimeType,_that.isSynthesizedPrompt,_that.originalImagePath,_that.originalImageMimeType,_that.videoPath,_that.videoUrl,_that.videoMimeType,_that.videoSizeBytes,_that.videoDurationMs,_that.participantId,_that.participantDisplayName,_that.participantRoleLabel,_that.participantColorValue,_that.participantToolNames,_that.handoffTargetParticipantId,_that.handoffTargetDisplayName,_that.handoffTargetRoleLabel,_that.responseMetrics);case _:
  return orElse();
