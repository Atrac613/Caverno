...
/// Create a copy of ConversationCheckpoint
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? messageId = null,Object? messageCount = null,Object? title = null,Object? createdAt = null,Object? executionMode = null,Object? workflowStage = null,Object? workflowSpec = freezed,Object? workflowSourceHash = null,Object? workflowDerivedAt = freezed,Object? executionProgress = null,Object? mutationGeneration = null,Object? verificationGeneration = null,Object? completionElicitationMutationGeneration = freezed,Object? openQuestionProgress = null,Object? taskAcceptances = null,Object? goal = freezed,Object? planArtifact = freezed,Object? compactionArtifact = freezed,}) {
...
as List<ConversationExecutionTaskProgress>,mutationGeneration: null == mutationGeneration ? _self.mutationGeneration : mutationGeneration // ignore: cast_nullable_to_non_nullable
as int,verificationGeneration: null == verificationGeneration ? _self.verificationGeneration : verificationGeneration // ignore: cast_nullable_to_non_nullable
as int,completionElicitationMutationGeneration: freezed == completionElicitationMutationGeneration ? _self.completionElicitationMutationGeneration : completionElicitationMutationGeneration // ignore: cast_nullable_to_non_nullable
as int?,openQuestionProgress: null == openQuestionProgress ? _self.openQuestionProgress : openQuestionProgress // ignore: cast_nullable_to_non_nullable
as List<ConversationOpenQuestionProgress>,taskAcceptances: null == taskAcceptances ? _self.taskAcceptances : taskAcceptances // ignore: cast_nullable_to_non_nullable
as List<ConversationTaskAcceptance>,goal: freezed == goal ? _self.goal : goal // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ConversationCheckpoint() when $default != null:
return $default(_that.messageId,_that.messageCount,_that.title,_that.createdAt,_that.executionMode,_that.workflowStage,_that.workflowSpec,_that.workflowSourceHash,_that.workflowDerivedAt,_that.executionProgress,_that.mutationGeneration,_that.verificationGeneration,_that.completionElicitationMutationGeneration,_that.openQuestionProgress,_that.taskAcceptances,_that.goal,_that.planArtifact,_that.compactionArtifact);case _:
  return orElse();
...
class _ConversationCheckpoint extends ConversationCheckpoint {
  const _ConversationCheckpoint({required this.messageId, required this.messageCount, required this.title, required this.createdAt, @JsonKey(unknownEnumValue: ConversationExecutionMode.normal) this.executionMode = ConversationExecutionMode.normal, @JsonKey(unknownEnumValue: ConversationWorkflowStage.idle) this.workflowStage = ConversationWorkflowStage.idle, @JsonKey(fromJson: _workflowSpecFromJson, toJson: _workflowSpecToJson) this.workflowSpec, this.workflowSourceHash = '', this.workflowDerivedAt, @JsonKey(fromJson: _executionProgressFromJson, toJson: _executionProgressToJson) final  List<ConversationExecutionTaskProgress> executionProgress = const <ConversationExecutionTaskProgress>[], this.mutationGeneration = 0, this.verificationGeneration = -1, this.completionElicitationMutationGeneration, @JsonKey(fromJson: _openQuestionProgressFromJson, toJson: _openQuestionProgressToJson) final  List<ConversationOpenQuestionProgress> openQuestionProgress = const <ConversationOpenQuestionProgress>[], @JsonKey(fromJson: _taskAcceptancesFromJson, toJson: _taskAcceptancesToJson) final  List<ConversationTaskAcceptance> taskAcceptances = const <ConversationTaskAcceptance>[], @JsonKey(fromJson: _goalFromJson, toJson: _goalToJson) this.goal, @JsonKey(fromJson: _planArtifactFromJson, toJson: _planArtifactToJson) this.planArtifact, @JsonKey(fromJson: _compactionArtifactFromJson, toJson: _compactionArtifactToJson) this.compactionArtifact}): _executionProgress = executionProgress,_openQuestionProgress = openQuestionProgress,_taskAcceptances = taskAcceptances,super._();
...
@override@JsonKey() final  int mutationGeneration;
@override@JsonKey() final  int verificationGeneration;
@override final  int? completionElicitationMutationGeneration;
...
@override@JsonKey(fromJson: _openQuestionProgressFromJson, toJson: _openQuestionProgressToJson) List<ConversationOpenQuestionProgress> get openQuestionProgress {
 ...
 final  List<ConversationTaskAcceptance> _taskAcceptances;
@override@JsonKey(fromJson: _taskAcceptancesFromJson, toJson: _taskAcceptancesToJson) List<ConversationTaskAcceptance> get taskAcceptances {
  if (_taskAcceptances is EqualUnmodifiableListView) return _taskAcceptances;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_taskAcceptances);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ConversationCheckpoint&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.messageCount, messageCount) || other.messageCount == messageCount)&&(identical(other.title, title) || other.title == title)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.executionMode, executionMode) || other.executionMode == executionMode)&&(identical(other.workflowStage, workflowStage) || other.workflowStage == workflowStage)&&(identical(other.workflowSpec, workflowSpec) || other.workflowSpec == workflowSpec)&&(identical(other.workflowSourceHash, workflowSourceHash) || other.workflowSourceHash == workflowSourceHash)&&(identical(other.workflowDerivedAt, workflowDerivedAt) || other.workflowDerivedAt == workflowDerivedAt)&&const DeepCollectionEquality().equals(other._executionProgress, _executionProgress)&&(identical(other.mutationGeneration, mutationGeneration) || other.mutationGeneration == mutationGeneration)&&(identical(other.verificationGeneration, verificationGeneration) || other.verificationGeneration == verificationGeneration)&&(identical(other.completionElicitationMutationGeneration, completionElicitationMutationGeneration) || other.completionElicitationMutationGeneration == completionElicitationMutationGeneration)&&const DeepCollectionEquality().equals(other._openQuestionProgress, _openQuestionProgress)&&const DeepCollectionEquality().equals(other._taskAcceptances, _taskAcceptances)&&(identical(other.goal, goal) || other.goal == goal)&&(identical(other.planArtifact, planArtifact) || other.planArtifact == planArtifact)&&(identical(other.compactionArtifact, compactionArtifact) || other.compactionArtifact == compactionArtifact));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,messageId,messageCount,title,createdAt,executionMode,workflowStage,workflowSpec,workflowSourceHash,workflowDerivedAt,const DeepCollectionEquality().hash(_executionProgress),mutationGeneration,verificationGeneration,completionElicitationMutationGeneration,const DeepCollectionEquality().hash(_openQuestionProgress),const DeepCollectionEquality().hash(_taskAcceptances),goal,planArtifact,compactionArtifact);
...
as int,verificationGeneration: null == verificationGeneration ? _self.verificationGeneration : verificationGeneration // ignore: cast_nullable_to_non_nullable
as int,completionElicitationMutationGeneration: freezed == completionElicitationMutationGeneration ? _self.completionElicitationMutationGeneration : completionElicitationMutationGeneration // ignore: cast_nullable_to_non_nullable
as int?,openQuestionProgress: null == openQuestionProgress ? _self._openQuestionProgress : openQuestionProgress // ignore: cast_nullable_to_non_nullable
as List<ConversationOpenQuestionProgress>,taskAcceptances: null == taskAcceptances ? _self._taskAcceptances : taskAcceptances // ignore: cast_nullable_to_non_nullable
as List<ConversationTaskAcceptance>,goal: freezed == goal ? _self.goal : goal // ignore: cast_nullable_to_non_nullable
as ConversationGoal?,planArtifact: freezed == planArtifact ? _self.planArtifact : planArtifact // ignore: cast_nullable_to_non_nullable
as ConversationPlanArtifact?,compactionArtifact: freezed == compactionArtifact ? _self.compactionArtifact : compactionArtifact // ignore: cast_nullable_to_non_nullable
as ConversationCompactionArtifact?,
...
mixin _$Conversation {
 ...
 String get id; String get title;@JsonKey(fromJson: _messagesFromJson, toJson: _messagesToJson) List<Message> get messages; DateTime get createdAt; DateTime get updatedAt;@JsonKey(unknownEnumValue: WorkspaceMode.chat) WorkspaceMode get workspaceMode; String get projectId; String get worktreePath;@JsonKey(unknownEnumValue: ConversationExecutionMode.normal) ConversationExecutionMode get executionMode;@JsonKey(unknownEnumValue: ConversationWorkflowStage.idle) ConversationWorkflowStage get workflowStage;@JsonKey(fromJson: _workflowSpecFromJson, toJson: _workflowSpecToJson) ConversationWorkflowSpec? get workflowSpec; String get workflowSourceHash; DateTime? get workflowDerivedAt;@JsonKey(fromJson: _executionProgressFromJson, toJson: _executionProgressToJson) List<ConversationExecutionTaskProgress> get executionProgress; int get mutationGeneration; int get verificationGeneration; int? get completionElicitationMutationGeneration;@JsonKey(fromJson: _openQuestionProgressFromJson, toJson: _openQuestionProgressToJson) List<ConversationOpenQuestionProgress> get openQuestionProgress;@JsonKey(fromJson: _goalFromJson, toJson: _goalToJson) ConversationGoal? get goal;@JsonKey(fromJson: _planArtifactFromJson, toJson: _planArtifactToJson) ConversationPlanArtifact? get planArtifact;@JsonKey(fromJson: _compactionArtifactFromJson, toJson: _compactionArtifactToJson) ConversationCompactionArtifact? get compactionArtifact;@JsonKey(fromJson: _checkpointsFromJson, toJson: _checkpointsToJson) List<ConversationCheckpoint> get checkpoints;@JsonKey(fromJson: _turnDiffsFromJson, toJson: _turnDiffsToJson) List<TurnDiff> get turnDiffs;@JsonKey(fromJson: _participantsFromJson, toJson: _participantsToJson) List<ConversationParticipant> get participants;@JsonKey(fromJson: _participantTurnConfigFromJson, toJson: _participantTurnConfigToJson) ParticipantTurnConfig get participantTurnConfig;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,const DeepCollectionEquality().hash(messages),createdAt,updatedAt,workspaceMode,projectId,worktreePath,executionMode,workflowStage,workflowSpec,workflowSourceHash,workflowDerivedAt,const DeepCollectionEquality().hash(executionProgress),mutationGeneration,verificationGeneration,completionElicitationMutationGeneration,const DeepCollectionEquality().hash(openQuestionProgress),goal,planArtifact,compactionArtifact,const DeepCollectionEquality().hash(checkpoints),const DeepCollectionEquality().hash(turnDiffs),const DeepCollectionEquality().hash(participants),participantTurnConfig]);

@override
String toString() {
  return 'Conversation(id: $id, title: $title, messages: $messages, createdAt: $createdAt, updatedAt: $updatedAt, workspaceMode: $workspaceMode, projectId: $projectId, worktreePath: $worktreePath, executionMode: $executionMode, workflowStage: $workflowStage, workflowSpec: $workflowSpec, workflowSourceHash: $workflowSourceHash, workflowDerivedAt: $workflowDerivedAt, executionProgress: $executionProgress, mutationGeneration: $mutationGeneration, verificationGeneration: $verificationGeneration, completionElicitationMutationGeneration: $completionElicitationMutationGeneration, openQuestionProgress: $openQuestionProgress, goal: $goal, planArtifact: $planArtifact, compactionArtifact: $compactionArtifact, checkpoints: $checkpoints, turnDiffs: $turnDiffs, participants: $participants, participantTurnConfig: $participantTurnConfig)';
}
...
@useResult
$Res call({
 String id, String title,@JsonKey(fromJson: _messagesFromJson, toJson: _messagesToJson) List<Message> messages, DateTime createdAt, DateTime updatedAt,@JsonKey(unknownEnumValue: WorkspaceMode.chat) WorkspaceMode workspaceMode, String projectId, String worktreePath,@JsonKey(unknownEnumValue: ConversationExecutionMode.normal) ConversationExecutionMode executionMode,@JsonKey(unknownEnumValue: ConversationWorkflowStage.idle) ConversationWorkflowStage workflowStage,@JsonKey(fromJson: _workflowSpecFromJson, toJson: _workflowSpecToJson) ConversationWorkflowSpec? workflowSpec, String workflowSourceHash, DateTime? workflowDerivedAt,@JsonKey(fromJson: _executionProgressFromJson, toJson: _executionProgressToJson) List<ConversationExecutionTaskProgress> executionProgress, int mutationGeneration, int verificationGeneration, int? completionElicitationMutationGeneration,@JsonKey(fromJson: _openQuestionProgressFromJson, toJson: _openQuestionProgressToJson) List<ConversationOpenQuestionProgress> openQuestionProgress,@JsonKey(fromJson: _goalFromJson, toJson: _goalToJson) ConversationGoal? goal,@JsonKey(fromJson: _planArtifactFromJson, toJson: _planArtifactToJson) ConversationPlanArtifact? planArtifact,@JsonKey(fromJson: _compactionArtifactFromJson, toJson: _compactionArtifactToJson) ConversationCompactionArtifact? compactionArtifact,@JsonKey(fromJson: _checkpointsFromJson, toJson: _checkpointsToJson) List<ConversationCheckpoint> checkpoints,@JsonKey(fromJson: _turnDiffsFromJson, toJson: _turnDiffsToJson) List<TurnDiff> turnDiffs,@JsonKey(fromJson: _participantsFromJson, toJson: _participantsToJson) List<ConversationParticipant> participants,@JsonKey(fromJson: _participantTurnConfigFromJson, toJson: _participantTurnConfigToJson) ParticipantTurnConfig participantTurnConfig
});
...
/// Create a copy of Conversation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? messages = null,Object? createdAt = null,Object? updatedAt = null,Object? workspaceMode = null,Object? projectId = null,Object? worktreePath = null,Object? executionMode = null,Object? workflowStage = null,Object? workflowSpec = freezed,Object? workflowSourceHash = null,Object? workflowDerivedAt = freezed,Object? executionProgress = null,Object? mutationGeneration = null,Object? verificationGeneration = null,Object? completionElicitationMutationGeneration = freezed,Object? openQuestionProgress = null,Object? goal = freezed,Object? planArtifact = freezed,Object? compactionArtifact = freezed,Object? checkpoints = null,Object? turnDiffs = null,Object? participants = null,Object? participantTurnConfig = null,}) {
  return _then(_self.copyWith(
...
switch (_that) {
case _Conversation() when $default != null:
return $default(_that.id,_that.title,_that.messages,_that.createdAt,_that.updatedAt,_that.workspaceMode,_that.projectId,_that.worktreePath,_that.executionMode,_that.workflowStage,_that.workflowSpec,_that.workflowSourceHash,_that.workflowDerivedAt,_that.executionProgress,_that.mutationGeneration,_that.verificationGeneration,_that.completionElicitationMutationGeneration,_that.openQuestionProgress,_that.goal,_that.planArtifact,_that.compactionArtifact,_that.checkpoints,_that.turnDiffs,_that.participants,_that.participantTurnConfig);case _:
  return orElse();
...
@override@JsonKey() final  String worktreePath;
@override@JsonKey(unknownEnumValue: ConversationExecutionMode.normal) final  ConversationExecutionMode executionMode;
@override@JsonKey(unknownEnumValue: ConversationWorkflowStage.idle) final  ConversationWorkflowStage workflowStage;
@override@JsonKey(fromJson: _workflowSpecFromJson, toJson: _workflowSpecToJson) final  ConversationWorkflowSpec? workflowSpec;
@override@JsonKey() final  String workflowSourceHash;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Conversation&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other._messages, _messages)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.workspaceMode, workspaceMode) || other.workspaceMode == workspaceMode)&&(identical(other.projectId, projectId) || other.projectId == projectId)&&(identical(other.worktreePath, worktreePath) || other.worktreePath == worktreePath)&&(identical(other.executionMode, executionMode) || other.executionMode == executionMode)&&(identical(other.workflowStage, workflowStage) || other.workflowStage == workflowStage)&&(identical(other.workflowSpec, workflowSpec) || other.workflowSpec == workflowSpec)&&(identical(other.workflowSourceHash, workflowSourceHash) || other.workflowSourceHash == workflowSourceHash)&&(identical(other.workflowDerivedAt, workflowDerivedAt) || other.workflowDerivedAt == workflowDerivedAt)&&const DeepCollectionEquality().equals(other._executionProgress, _executionProgress)&&(identical(other.mutationGeneration, mutationGeneration) || other.mutationGeneration == mutationGeneration)&&(identical(other.verificationGeneration, verificationGeneration) || other.verificationGeneration == verificationGeneration)&&(identical(other.completionElicitationMutationGeneration, completionElicitationMutationGeneration) || other.completionElicitationMutationGeneration == completionElicitationMutationGeneration)&&const DeepCollectionEquality().equals(other._openQuestionProgress, _openQuestionProgress)&&(identical(other.goal, goal) || other.goal == goal)&&(identical(other.planArtifact, planArtifact) || other.planArtifact == planArtifact)&&(identical(other.compactionArtifact, compactionArtifact) || other.compactionArtifact == compactionArtifact)&&const DeepCollectionEquality().equals(other._checkpoints, _checkpoints)&&const DeepCollectionEquality().equals(other._turnDiffs, _turnDiffs)&&const DeepCollectionEquality().equals(other._participants, _participants)&&(identical(other.participantTurnConfig, participantTurnConfig) || other.participantTurnConfig == participantTurnConfig));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,const DeepCollectionEquality().hash(_messages),createdAt,updatedAt,workspaceMode,projectId,worktreePath,executionMode,workflowStage,workflowSpec,workflowSourceHash,workflowDerivedAt,const DeepCollectionEquality().hash(_executionProgress),mutationGeneration,verificationGeneration,completionElicitationMutationGeneration,const DeepCollectionEquality().hash(_openQuestionProgress),goal,planArtifact,compactionArtifact,const DeepCollectionEquality().hash(_checkpoints),const DeepCollectionEquality().hash(_turnDiffs),const DeepCollectionEquality().hash(_participants),participantTurnConfig]);
