...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,messageId,messageCount,title,createdAt,executionMode,workflowStage,workflowSpec,workflowSourceHash,workflowDerivedAt,const DeepCollectionEquality().hash(executionProgress),mutationGeneration,verificationGeneration,const DeepCollectionEquality().hash(openQuestionProgress),goal,planArtifact,compactionArtifact);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,messageId,messageCount,title,createdAt,executionMode,workflowStage,workflowSpec,workflowSourceHash,workflowDerivedAt,const DeepCollectionEquality().hash(_executionProgress),mutationGeneration,verificationGeneration,const DeepCollectionEquality().hash(_openQuestionProgress),goal,planArtifact,compactionArtifact);
