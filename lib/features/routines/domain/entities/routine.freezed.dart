...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,startedAt,finishedAt,status,trigger,durationMs,usedTools,toolCallCount,const DeepCollectionEquality().hash(toolNames),preview,output,error);

@override
String toString() {
  return 'RoutineRunRecord(id: $id, startedAt: $startedAt, finishedAt: $finishedAt, status: $status, trigger: $trigger, durationMs: $durationMs, usedTools: $usedTools, toolCallCount: $toolCallCount, toolNames: $toolNames, preview: $preview, output: $output, error: $error)';
}
...
@useResult
$Res call({
 String id, DateTime startedAt, DateTime finishedAt,@JsonKey(unknownEnumValue: RoutineRunStatus.completed) RoutineRunStatus status,@JsonKey(unknownEnumValue: RoutineRunTrigger.manual) RoutineRunTrigger trigger, int durationMs, bool usedTools, int toolCallCount, List<String> toolNames, String preview, String output, String error
});
...
/// Create a copy of RoutineRunRecord
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? startedAt = null,Object? finishedAt = null,Object? status = null,Object? trigger = null,Object? durationMs = null,Object? usedTools = null,Object? toolCallCount = null,Object? toolNames = null,Object? preview = null,Object? output = null,Object? error = null,}) {
...
as List<String>,preview: null == preview ? _self.preview : preview // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime startedAt,  DateTime finishedAt, @JsonKey(unknownEnumValue: RoutineRunStatus.completed)  RoutineRunStatus status, @JsonKey(unknownEnumValue: RoutineRunTrigger.manual)  RoutineRunTrigger trigger,  int durationMs,  bool usedTools,  int toolCallCount,  List<String> toolNames,  String preview,  String output,  String error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoutineRunRecord() when $default != null:
return $default(_that.id,_that.startedAt,_that.finishedAt,_that.status,_that.trigger,_that.durationMs,_that.usedTools,_that.toolCallCount,_that.toolNames,_that.preview,_that.output,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime startedAt,  DateTime finishedAt, @JsonKey(unknownEnumValue: RoutineRunStatus.completed)  RoutineRunStatus status, @JsonKey(unknownEnumValue: RoutineRunTrigger.manual)  RoutineRunTrigger trigger,  int durationMs,  bool usedTools,  int toolCallCount,  List<String> toolNames,  String preview,  String output,  String error)  $default,) {final _that = this;
switch (_that) {
case _RoutineRunRecord():
return $default(_that.id,_that.startedAt,_that.finishedAt,_that.status,_that.trigger,_that.durationMs,_that.usedTools,_that.toolCallCount,_that.toolNames,_that.preview,_that.output,_that.error);case _:
  throw StateError('Unexpected subclass');
...
class _RoutineRunRecord extends RoutineRunRecord {
  const _RoutineRunRecord({required this.id, required this.startedAt, required this.finishedAt, @JsonKey(unknownEnumValue: RoutineRunStatus.completed) this.status = RoutineRunStatus.completed, @JsonKey(unknownEnumValue: RoutineRunTrigger.manual) this.trigger = RoutineRunTrigger.manual, this.durationMs = 0, this.usedTools = false, this.toolCallCount = 0, final  List<String> toolNames = const <String>[], this.preview = '', this.output = '', this.error = ''}): _toolNames = toolNames,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,startedAt,finishedAt,status,trigger,durationMs,usedTools,toolCallCount,const DeepCollectionEquality().hash(_toolNames),preview,output,error);
...
/// Create a copy of RoutineRunRecord
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? startedAt = null,Object? finishedAt = null,Object? status = null,Object? trigger = null,Object? durationMs = null,Object? usedTools = null,Object? toolCallCount = null,Object? toolNames = null,Object? preview = null,Object? output = null,Object? error = null,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,prompt,createdAt,updatedAt,enabled,notifyOnCompletion,toolsEnabled,intervalValue,intervalUnit,nextRunAt,lastRunAt,const DeepCollectionEquality().hash(runs));

@override
String toString() {
  return 'Routine(id: $id, name: $name, prompt: $prompt, createdAt: $createdAt, updatedAt: $updatedAt, enabled: $enabled, notifyOnCompletion: $notifyOnCompletion, toolsEnabled: $toolsEnabled, intervalValue: $intervalValue, intervalUnit: $intervalUnit, nextRunAt: $nextRunAt, lastRunAt: $lastRunAt, runs: $runs)';
}
...
@useResult
$Res call({
 String id, String name, String prompt, DateTime createdAt, DateTime updatedAt, bool enabled, bool notifyOnCompletion, bool toolsEnabled, int intervalValue,@JsonKey(unknownEnumValue: RoutineIntervalUnit.hours) RoutineIntervalUnit intervalUnit, DateTime? nextRunAt, DateTime? lastRunAt, List<RoutineRunRecord> runs
});
...
/// Create a copy of Routine
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? prompt = null,Object? createdAt = null,Object? updatedAt = null,Object? enabled = null,Object? notifyOnCompletion = null,Object? toolsEnabled = null,Object? intervalValue = null,Object? intervalUnit = null,Object? nextRunAt = freezed,Object? lastRunAt = freezed,Object? runs = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String prompt,  DateTime createdAt,  DateTime updatedAt,  bool enabled,  bool notifyOnCompletion,  bool toolsEnabled,  int intervalValue, @JsonKey(unknownEnumValue: RoutineIntervalUnit.hours)  RoutineIntervalUnit intervalUnit,  DateTime? nextRunAt,  DateTime? lastRunAt,  List<RoutineRunRecord> runs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Routine() when $default != null:
return $default(_that.id,_that.name,_that.prompt,_that.createdAt,_that.updatedAt,_that.enabled,_that.notifyOnCompletion,_that.toolsEnabled,_that.intervalValue,_that.intervalUnit,_that.nextRunAt,_that.lastRunAt,_that.runs);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,prompt,createdAt,updatedAt,enabled,notifyOnCompletion,toolsEnabled,intervalValue,intervalUnit,nextRunAt,lastRunAt,const DeepCollectionEquality().hash(_runs));
