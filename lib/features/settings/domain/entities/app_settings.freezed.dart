...
// behaviour (follow the primary).
 String get embeddingsEndpointId; bool get showMemoryUpdates;// On in debug builds so development traces are captured without setup;
