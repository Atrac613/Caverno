...
// dedicated model independently from ordinary chat and plan drafting.
 String get proReasoningModel;// LL8 per-role endpoint routing. Empty string means "use the primary
...
as ProReasoningDepth,generalPrimaryModel: null == generalPrimaryModel ? _self.generalPrimaryModel : generalPrimaryModel // ignore: cast_nullable_to_non_nullable
