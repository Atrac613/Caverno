...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,llmProvider,baseUrl,model,apiKey,temperature,maxTokens,reasoningEffort,memoryExtractionModel,subagentModel,goalSuggestionModel,approvalAutoReviewModel,googleChatWebhookUrl,mcpUrl,const DeepCollectionEquality().hash(_mcpUrls),const DeepCollectionEquality().hash(_mcpServers),mcpEnabled,ttsEnabled,autoReadEnabled,speechRate,voiceModeAutoStop,whisperUrl,voicevoxUrl,voicevoxSpeakerId,language,assistantMode,codingApprovalMode,chatApprovalMode,confirmFileMutations,confirmLocalCommands,confirmGitWrites,enableCodingVerificationFeedback,codingVerificationTriggerPolicy,codingVerificationTimeoutSeconds,codingVerificationMaxFailures,enableAgentsMd,enablePrefixStableToolLoop,showMemoryUpdates,enableLlmSessionLogs,demoMode,onboardingCompleted,browserToolsEnabled,const DeepCollectionEquality().hash(_disabledBuiltInTools),const DeepCollectionEquality().hash(_localCommandPermissionRules),const DeepCollectionEquality().hash(_routineComputerUseActionAllowlist),const DeepCollectionEquality().hash(_modelCapabilityProfiles),const DeepCollectionEquality().hash(_modelHarnessConfigs),const DeepCollectionEquality().hash(_modelCapabilityProfileRevisions),idleMaintenanceEnabled,idleMaintenanceWindowStartMinutes,idleMaintenanceWindowEndMinutes,idleMaintenanceMinIdleMinutes,idleMaintenanceRequireAcPower]);
