...
// Lets secondary LLM calls run on a smaller, faster local model.
 String get memoryExtractionModel; String get subagentModel; String get goalSuggestionModel; String get approvalAutoReviewModel; String get googleChatWebhookUrl; String get mcpUrl; List<String> get mcpUrls; List<McpServerConfig> get mcpServers; bool get mcpEnabled;// Voice settings
...
as List<ModelHarnessConfig>,idleMaintenanceEnabled: null == idleMaintenanceEnabled ? _self.idleMaintenanceEnabled : idleMaintenanceEnabled // ignore: cast_nullable_to_non_nullable
