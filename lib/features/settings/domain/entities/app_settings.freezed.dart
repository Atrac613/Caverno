...
as ProReasoningDepth,memoryExtractionModel: null == memoryExtractionModel ? _self.memoryExtractionModel : memoryExtractionModel // ignore: cast_nullable_to_non_nullable
