    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _RoleModelDropdown(
            fieldKey: const ValueKey('model-routing-log-analysis'),
            label: 'settings.model_routing_log_analysis'.tr(),
            helper: 'settings.model_routing_log_analysis_desc'.tr(),
            value: settings.logAnalysisModel,
            effectiveDefaultModel: settings.effectiveLogAnalysisModel,
            asyncModels: modelsFor(settings.logAnalysisEndpointId),
            enabled: !isAppleProvider,
            onChanged: notifier.updateLogAnalysisModel,
          ),
          _RoleEndpointDropdown(
            fieldKey: const ValueKey('endpoint-routing-log-analysis'),
            value: settings.logAnalysisEndpointId,
            endpoints: settings.enabledLlmEndpoints,
            enabled: !isAppleProvider,
            onChanged: notifier.updateLogAnalysisEndpointId,
          ),
          const SizedBox(height: 16),
          _RoleModelDropdown(
